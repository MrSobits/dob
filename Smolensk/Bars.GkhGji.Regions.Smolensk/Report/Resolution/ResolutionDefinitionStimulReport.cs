    ...
    public class ResolutionDefinitionStimulReport : GkhBaseStimulReport
    {
        ...
        public override void PrepareReport(ReportParams reportParams)
        {
            ...
            if (Definition.IssuedDefinition != null)
            {
                ...
                Report["РуководительФИО"] = sokrFio;
                Report["ДолжностьРуководителя"] = Definition.IssuedDefinition.Position;
                Report["КодРуководителяФИО_сИнициалами"] =
            ...
            {
                Report["Инспектор"] = resolution.Official.Fio;
            }
            
            Report["Правонарушитель"] = resolution.Contragent != null
                                                                     ? resolution.Contragent.Name
                                                                     : resolution.PhysicalPerson;
            
            Report["Контрагент"] = resolution.Contragent != null ? resolution.Contragent.Name
                                                                : string.Empty;
            ...
            Report["НаселенныйПункт"] = placeName;
        }
