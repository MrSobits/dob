namespace Bars.Gkh.Overhaul.Tat.DomainService
{
    ...
    public class ProgramCrCopByDpkr : IProgramCrCopByDpkr
    {
        ...
        private T ToDerived<T>(T tBase, PropertyInfo[] propertyes)
        ...
        private PropertyInfo[] GetPropertiesForCopy(Type type)
        {
        ...
        {
            var logger = this.Container.Resolve<ILogManager>();

            logger.Debug("Копирование программы | инициализация параметров");
            ...
            logger.Debug("Копирование программы | получение сервисов/репозиториев");
            ...
            try
            {
                logger.Debug("Копирование программы | получение списка свойств");
                ...
                logger.Debug("Копирование программы | кэширование данных");
                ...
                var defectListDict = defectListService.GetAll().Where(x => x.ObjectCr.ProgramCr.Id == oldProgramCrId).Fetch(x => x.File).ToList().GroupBy(x => x.ObjectCr.Id).ToDictionary(x => x.Key, y => y.ToList());
                ...
                using (var tr = Container.Resolve<IDataTransaction>())
                {
                    try
                    {
                        ...
                        logger.Debug("Копирование программы | история");
                        ...
                        logger.Debug("Копирование программы | Фин. источники программы");
                        ...
                        logger.DebugFormat("Копирование программы | Фин. источники программы, скопировано {0}", programCrFinSourceSaveList.Count);

                        // Объекты КР программы
                        logger.Debug("Копирование программы | Объекты КР программы");
                        ...
                        logger.DebugFormat("Копирование программы | Объекты КР программы, скопировано {0}", objectCrSaveList.Count);
                        ...
                        logger.Debug("Копирование программы | сохранение программы");
                        ...
                        logger.Debug("Копирование программы | сохранение истории");
                        programCrJournalService.Save(newHistory);

                        logger.Debug("Копирование программы | сохранение programCrFinSourceSaveList");
                        ...
                        logger.DebugFormat("Копирование программы | сохранение programCrFinSourceSaveList ({0})", programCrFinSourceSaveList.Count);

                        logger.Debug("Копирование программы | сохранение objectCrSaveList");
                        ...
                        logger.DebugFormat("Копирование программы | сохранение objectCrSaveList ({0})", objectCrSaveList.Count);

                        logger.Debug("Копирование программы | сохранение typeWorkCrSaveList");
                        ...
                        logger.DebugFormat("Копирование программы | сохранение typeWorkCrSaveList ({0})", typeWorkCrSaveList.Count);

                        logger.Debug("Копирование программы | сохранение typeWorkStage1SaveList");
                        ...
                        logger.DebugFormat("Копирование программы | сохранение typeWorkStage1SaveList ({0})", typeWorkStage1SaveList.Count);

                        logger.Debug("Копирование программы | сохранение performedWorkActSaveList");
                        ...
                        logger.DebugFormat("Копирование программы | сохранение performedWorkActSaveList ({0})", performedWorkActSaveList.Count);

                        logger.Debug("Копирование программы | сохранение performedWorkActRecordSaveList");
                        ...
                        logger.DebugFormat("Копирование программы | сохранение performedWorkActRecordSaveList ({0})", performedWorkActRecordSaveList.Count);

                        logger.Debug("Копирование программы | сохранение qualificationSaveList");
                        ...
                        logger.DebugFormat("Копирование программы | сохранение qualificationSaveList ({0})", qualificationSaveList.Count);

                        logger.Debug("Копирование программы | сохранение voiceMemberSaveList");
                        ...
                        logger.DebugFormat("Копирование программы | сохранение voiceMemberSaveList ({0})", voiceMemberSaveList.Count);

                        logger.Debug("Копирование программы | сохранение buildContractSaveList");
                        ...
                        logger.DebugFormat("Копирование программы | сохранение buildContractSaveList ({0})", buildContractSaveList.Count);

                        logger.Debug("Копирование программы | сохранение contractCrSaveList");
                        ...
                        logger.DebugFormat("Копирование программы | сохранение contractCrSaveList ({0})", contractCrSaveList.Count);

                        logger.DebugFormat("Копирование программы | сохранение defectListSaveList");
                        ...
                        logger.DebugFormat("Копирование программы | сохранение defectListSaveList ({0})", defectListSaveList.Count);

                        logger.DebugFormat("Копирование программы | сохранение documentWorkCrSaveList");
                        ...
                        logger.DebugFormat("Копирование программы | сохранение documentWorkCrSaveList ({0})", documentWorkCrSaveList.Count);

                        logger.DebugFormat("Копирование программы | сохранение financeSourceResourceSaveList");
                        ...
                        logger.DebugFormat("Копирование программы | сохранение financeSourceResourceSaveList ({0})", financeSourceResourceSaveList.Count);

                        logger.DebugFormat("Копирование программы | сохранение monitoringSmrSaveList");
                        ...
                        logger.DebugFormat("Копирование программы | сохранение monitoringSmrSaveList ({0})", monitoringSmrSaveList.Count);

                        logger.DebugFormat("Копирование программы | сохранение personalAccountSaveList");
                        ...
                        logger.DebugFormat("Копирование программы | сохранение personalAccountSaveList ({0})", personalAccountSaveList.Count);

                        logger.DebugFormat("Копирование программы | сохранение protocolCrSaveList");
                        ...
                        logger.DebugFormat("Копирование программы | сохранение protocolCrSaveList ({0})", protocolCrSaveList.Count);

                        logger.DebugFormat("Копирование программы | Commit");
                        tr.Commit();
                        logger.DebugFormat("Копирование программы | Завершено успешно");
                    ...
                    {
                        logger.DebugFormat("Копирование программы | Rollback", exc);
                        tr.Rollback();
                        return new BaseDataResult
                        {
                            Success = false,
            ...
            {
                logger.Debug("Копирование программы | освобождаем ресурсы");
