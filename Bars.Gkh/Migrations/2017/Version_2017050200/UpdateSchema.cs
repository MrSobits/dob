namespace Bars.Gkh.Migrations._2017.Version_2017050200
{
    ...
    public class UpdateSchema : Migration
    {
        ...
        {
            this.AddContragentId(FormatDataExportSequences.ContragentExprtId);
            this.AddContractId(FormatDataExportSequences.ContragentRschetExprtId);
        ...
        {
            this.RemoveContragentId(FormatDataExportSequences.ContragentExprtId);
            this.RemoveContractId(FormatDataExportSequences.ContragentRschetExprtId);
        ...
        private void AddContractId(string sequenceName)
        {
            this.Database.AddSequence(sequenceName);

            this.AddExportId("CR_OBJ_CONTRACT", sequenceName);
            this.AddExportId("CR_OBJ_BUILD_CONTRACT", sequenceName);
        }

        private void RemoveContractId(string sequenceName)
        {
            this.RemoveExportId("CR_OBJ_CONTRACT");
            this.RemoveExportId("CR_OBJ_BUILD_CONTRACT");
