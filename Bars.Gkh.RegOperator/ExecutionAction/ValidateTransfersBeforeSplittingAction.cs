namespace Bars.Gkh.RegOperator.ExecutionAction
{
    ...
    /// </summary>
    public class ValidateTransfersBeforeSplittingAction : BaseMandatoryExecutionAction
    {
        ...
        {
            return base.IsNeedAction() && !ExecutionActionHelper.IsSuccess<CreateTransfersWithOwnersAction>();
        }
