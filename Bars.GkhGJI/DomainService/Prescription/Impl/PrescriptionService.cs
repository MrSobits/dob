namespace Bars.GkhGji.DomainService
{
    ...
    public class PrescriptionService : IPrescriptionService
    {
        ...
        {
            var serviceDisposalInspector = Container.Resolve<IDocumentGjiInspectorService>();
            try
            {
        ...
        public virtual IDataResult ListView(BaseParams baseParams)
        {
            ...
            */
            ...
            var data = GetViewList()
                .WhereIf(!showboth && showYellow, x=> x.HasNotRemoovedViolations && x.DateRemoval.HasValue && x.DateRemoval.Value <= DateTime.Now.AddDays(4) && x.DateRemoval.Value > DateTime.Now)
                 .WhereIf(!showboth && showRed, x => x.HasNotRemoovedViolations && x.DateRemoval.HasValue && x.DateRemoval.Value <= DateTime.Now && x.DisposalId == 0)
                 .WhereIf(showboth, x => x.HasNotRemoovedViolations && x.DateRemoval.HasValue && x.DateRemoval.Value <= DateTime.Now.AddDays(4) && x.DisposalId == 0)
        ...
        {
            var loadParam = baseParams.GetLoadParam();
            var prescService = Container.Resolve<IDomainService<Prescription>>();
            var prescViolService = Container.Resolve<IDomainService<PrescriptionViol>>();
            ...
            {
                Container.Release(prescService);
        ...
        public virtual IQueryable<ViewPrescription> GetViewList()
        {
            ...
            return Container.Resolve<IDomainService<ViewPrescription>>().GetAll()
