namespace Bars.GkhGji.Regions.Stavropol.Report.ProtocolGji
{
    ...
    public class ProtocolGjiStimulReport : GjiBaseStimulReport
    {
        ...
        {
            Report["Номер"] = _protocol.DocumentNumber;
        ...
        protected void FillProtocolContragent()
        {
            ...
            if (contragent != null)
            {
                Report["Контрагент"] = contragent.ShortName;
                ...
                Report["АдресКонтрагента"] = contragent.FiasJuridicalAddress != null
        ...
        protected void FillContragentBank()
        {
            ...
            using (Container.Using(contragentBankDomain))
            {
                ...
                {
                    Report["КСчёт"] = contragentBank.CorrAccount;
                    Report["РСчет"] = contragentBank.SettlementAccount;
        ...
        protected void FillContragentContact()
        {
            ...
            using (Container.Using(contragentContactDomain))
            {
                ...
                if (contact != null)
                {
                    Report["РукУпрОрг"] = string.Format("{0} {1}", contact.Position.Name, contact.FullName);
                    Report["ТлфРуководителяУО"] = contact.Phone;
                }
            }
        }
            ...
            using (Container.Using(actCheckDomain))
            {
                ...
                if (actCheck != null)
                {
                    using (Container.Using(actCheckRealityObjectDomain))
                    {
                        ...
                        {
                            Report["Описание"] = realityObjects.First().Description;
                        }
                    }
