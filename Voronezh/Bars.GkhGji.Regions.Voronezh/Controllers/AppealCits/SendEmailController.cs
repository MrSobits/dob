namespace Bars.GkhGji.Regions.Voronezh.Controllers
{
    ...
    public class SendEmailController : BaseController
    {
        ...
        string MakeMessageBody(AppealCits cits)
        {
            ...
            body += $"Государственная Административная комиссия Воронежской области сообщает, что обращение от {cits.DateFrom.Value.ToShortDateString()} № {cits.DocumentNumber} рассмотрено, файл ответа прикреплен к настоящему электронному сообщению.\r\n";
