                    ...
                    B4.Ajax.request({
                        ...
                        switch (typeExec.Code) {
                            ...
                            case "19":
                                ...
                                panel.down('#dfPhysicalPersonDocumentSerial').allowBlank = false;
                                panel.down('#dfPhysicalPersonDocumentNumber').allowBlank = false;
                                panel.down('#dfPhysicalPersonDocType').allowBlank = false;
