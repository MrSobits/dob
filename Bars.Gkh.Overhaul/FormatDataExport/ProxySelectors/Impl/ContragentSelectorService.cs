namespace Bars.Gkh.Overhaul.FormatDataExport.ProxySelectors.Impl
{
    ...
    /// </summary>
    public class ContragentSelectorService : Bars.Gkh.FormatDataExport.ProxySelectors.Impl.ContragentSelectorService
    {
        protected override IEnumerable<ContragentProxy> GetProxies(IQueryable<Contragent> contragentQuery, IQueryable<ContragentContact> contactQuery)
        {
