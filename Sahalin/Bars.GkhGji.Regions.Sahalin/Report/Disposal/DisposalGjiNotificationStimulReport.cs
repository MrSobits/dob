    ...
    public class DisposalGjiNotificationStimulReport : GjiBaseStimulReport
    {
        ...
        public override void PrepareReport(ReportParams reportParams)
        {
            ...
            try
            {
                ...
                Report.RegData("ЦелиПроверки", goals);

                Report.RegData("Уведомление", new
                {
                ...
                Report.RegData("Руководитель", new
                {
                ...
                var listDisposalProvidedDoc = disposalProvideDocDomain.GetAll()
                    ...
                    .ToList();
                Report.RegData("ПредоставляемыеДокументы", listDisposalProvidedDoc);
            }
            finally
            {
