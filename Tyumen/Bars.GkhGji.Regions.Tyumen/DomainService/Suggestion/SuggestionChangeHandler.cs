namespace Bars.GkhGji.Regions.Tyumen.DomainService.Suggestion
{
    ...
    public class SuggestionChangeHandler : ISuggestionChangeHandler
    {
        ...
        public SuggestionChangeHandler(IWindsorContainer container, ILogManager logManager, IDomainService<ApplicantNotification> appNotificationDomain)
        {
        ...
        private void SendEmailExecutor(SuggestionComment comment, Transition transition)
        {
            ...
            catch (Exception e)
            {
                ...
                this.Container.Resolve<ILogManager>().Error(message);
            }
        }
