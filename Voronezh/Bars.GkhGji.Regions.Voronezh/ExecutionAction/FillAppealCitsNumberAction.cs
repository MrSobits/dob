namespace Bars.GkhGji.Regions.Voronezh.ExecutionAction
{
    ...
    public class FillAppealCitsNumberAction : BaseMandatoryExecutionAction
    {
        ...
        /// <inheritdoc />
        public override string Description => "Комиссии - Действие заполняет поле Number таблицы обращений GJI_APPEAL_CITIZENS";

        /// <inheritdoc />
        public override string Name => "Комиссии - Заполнение номера обращений";
