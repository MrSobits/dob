namespace Bars.Gkh.RegOperator.DomainModelServices.PersonalAccount.Impl
{
    ...
    public class PersonalAccountDetailService : IPersonalAccountDetailService
    {
        ...
        /// <returns></returns>
        public ListDataResult<PeriodDetail> GetPeriodDetail(BaseParams baseParams)
        {
            ...
            return new ListDataResult<PeriodDetail>(details.AsQueryable().Order(loadParam).Paging(loadParam).ToList(), details.Count);
        }
        ...
        /// Детализация по полям лс
        /// </summary>
        public ListDataResult<FieldDetail> GetFieldDetail(BaseParams baseParams)
        {
            ...
            return new ListDataResult<FieldDetail>(result, fieldDetail.Count);
        }
        ...
        /// Детализация операций по периоду
        /// </summary>
        public ListDataResult<PeriodOperationDetail> GetPeriodOperationDetail(BaseParams baseParams)
        {
            ...
            {
                return new ListDataResult<PeriodOperationDetail>();
            }
            ...
            return new ListDataResult<PeriodOperationDetail>(result.ToList(), totalCount);
        }
