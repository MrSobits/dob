...
namespace Bars.GkhGji.Interceptors
{
        ...
        where T : HeatSeasonDoc
    {
        ...
        public virtual IDataResult CheckDocuments(IDomainService<T> service, T entity)
        {
            ...
            if (entity.TypeDocument == HeatSeasonDocType.Passport)
            {
                if (entity.HeatingSeason.HeatingSystem == HeatingSystem.Centralized && mandatoryDocsTypeCentralized.Any(x => !existDocsType.Contains(x)))
                {
                ...
                if (entity.HeatingSeason.HeatingSystem == HeatingSystem.Individual
