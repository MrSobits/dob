namespace Bars.GkhDi.Services.Domain
{
    ...
    public class ServiceDi : IServiceDi
    {
        ...
        public GetManOrgRealtyObjectInfoResponse GetManOrgRealtyObjectInfo(string houseId)
        {
            ...
            var informationOnContracts = this.Container.Resolve<IDomainService<Entities.InformationOnContracts>>()
                                .GetAll()
            ...
            var infoAboutReductionPayment = this.Container.Resolve<IDomainService<InfoAboutReductionPayment>>()
                                .GetAll()
            ...
            var planReductionExpenseWorks = this.Container.Resolve<IDomainService<PlanReductionExpenseWorks>>()
                                .GetAll()
            ...
            var workPprRepairDetailService = Container.Resolve<IDomainService<WorkRepairDetail>>();
            var planWorkServiceRepWorksItem = this.Container.Resolve<IDomainService<PlanWorkServiceRepairWorks>>()
                                .GetAll()
            ...
            var workRepairTechServ = this.Container.Resolve<IDomainService<WorkRepairTechServ>>().GetAll()
                .Where(x => x.BaseService.DisclosureInfoRealityObj.RealityObject.Id == idHouse)
                .Select(x => new
                {
                    x.BaseService.Id,
            ...
            // Документы
            var documents = this.Container.Resolve<IDomainService<DocumentsRealityObj>>()
                                .GetAll()
                                .Where(x => x.DisclosureInfoRealityObj.RealityObject.Id == idHouse)
                                .Select(
                                    x => new
            ...
            var protocols = this.Container.Resolve<IDomainService<DocumentsRealityObjProtocol>>()
                    .GetAll()
                    .Where(x => x.RealityObject.Id == idHouse)
                    .Select(
                        x => new
            ...
            // Прочие услуги
            var otherService = this.Container.Resolve<IDomainService<OtherService>>()
                                .GetAll()
                                .Where(x => x.DisclosureInfoRealityObj.RealityObject.Id == idHouse)
                                .Select(
                                    x => new
            ...
            // Сведения об оплатах
            var infoAboutPaymentHousing = this.Container.Resolve<IDomainService<InfoAboutPaymentHousing>>()
                                .GetAll()
                                .Where(x => x.DisclosureInfoRealityObj.RealityObject.Id == idHouse)
                                .Select(
                                    x => new
            ...
            var infoAboutPaymentCommunal = this.Container.Resolve<IDomainService<InfoAboutPaymentCommunal>>()
                                .GetAll()
                                .Where(x => x.DisclosureInfoRealityObj.RealityObject.Id == idHouse)
                                .Select(
                                    x => new
            ...
            var infoAboutCommonFacil = this.Container.Resolve<IDomainService<InfoAboutUseCommonFacilities>>()
                                .GetAll()
                                .Where(x => x.DisclosureInfoRealityObj.RealityObject.Id == idHouse)
                                .Select(
                                    x => new
            ...
            var nonResidentialPlacement = this.Container.Resolve<IDomainService<NonResidentialPlacement>>()
                                .GetAll()
                                .Where(x => x.DisclosureInfoRealityObj.RealityObject.Id == idHouse)
                                .Select(
                                    x => new
            ...
            var nonResidentialPlaceMeteringDevice = this.Container.Resolve<IDomainService<NonResidentialPlacementMeteringDevice>>()
                                .GetAll()
            ...
            // Услуги
            var providerService = Container.Resolve<IDomainService<ProviderService>>();
            ...
            var repairService = Container.Resolve<IDomainService<RepairService>>()
                                ...
                                .ToDictionary(x => x.Key, y => y.AsEnumerable()
                                                    .Select(z => new ServiceItem
                                                    {
                                                        ...
                                                        Name = z.Name.ToStr(),
                                                        UnitMeasure = z.UnitMeasure.ToStr(),
                                                        Provider = !z.ProviderName.IsEmpty() ? z.ProviderName : providerService.GetAll()
                                ...
                                .Select(
                                    x =>
                                        new
                                        {
                                            ...
                                            x.DisclosureInfo.ManagingOrganization.Contragent.Inn,
                                            x.DisclosureInfo.ManagingOrganization.Contragent.PhoneDispatchService,
                                            ...
                                            DirectorFio = Container.Resolve<IDomainService<ContragentContact>>().GetAll().Where(y => y.Contragent.Id == x.DisclosureInfo.ManagingOrganization.Contragent.Id && y.Position.Code == "1" && y.DateStartWork.HasValue && !y.DateEndWork.HasValue).Select(y => y.FullName).FirstOrDefault(),
                            ...
                            .Select(
                                ...
                                new PeriodItem
                                {
                                    ...
                                    ? mangingOrgs[x.Id].Select(y => new ManagingOrgItem()
                                    {
                                        ...
                                        Phone = y.Phone.ToStr(),
                                        PhoneDispatchService = y.PhoneDispatchService.ToStr(),
                                        Email = y.Email.ToStr(),
                                        DirectorFio = y.DirectorFio.ToStr(),
                                        ...
                                        {
                                            Services = this.MergeServices(y.PeriodId, new List<Dictionary<long, List<ServiceItem>>>
                                                {
                                                    communalService,
                                                    housingService,
                                                    additionalService,
                                            ...
                                            InfoAboutPay = this.MergeServices(y.PeriodId, new List<Dictionary<long, List<InfoAboutPayItem>>>
                                                {
                                            ...
                                            OrderAndConditionService = new OrderAndConditionService
                                            {
                                                ...
                                                InformationOnContracts = new Bars.GkhDi.Services.DataContracts.GetManOrgRealtyObjectInfo.InformationOnContracts
                                                {
