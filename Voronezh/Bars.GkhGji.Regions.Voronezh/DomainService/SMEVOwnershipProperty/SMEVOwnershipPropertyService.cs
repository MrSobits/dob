    ...
    public class SMEVOwnershipPropertyService : ISMEVOwnershipPropertyService
    {
        ...
        private XElement GetInformationRequestXML(SMEVOwnershipProperty requestData)
        {
            ...
            if (requestData.QueryType == Enums.QueryTypeType.CadasterNumberQuery)
            {
                ...
                //формируем из класса
            SGIO.Ownership.RequestType requestType = new SGIO.Ownership.RequestType
            {
                DeclarantINN = "3664032439",
                DeclarantName = "ГОСУДАРСТВЕННАЯ Административная комиссия ВОРОНЕЖСКОЙ ОБЛАСТИ",
            ...
            //    new XElement("DeclarantName", "ГОСУДАРСТВЕННАЯ Административная комиссия ВОРОНЕЖСКОЙ ОБЛАСТИ"),
        ...
        private XElement GetRequestElement(SGIO.Ownership.RequestType request)
        {
