namespace Bars.GkhGji.Regions.BaseChelyabinsk.Report.Protocol197
{
    ...
    public class IzvRassmComiss197StimulReport : GjiBaseStimulReport, IComissionMeetingCodedReport
    {
		public IzvRassmComiss197StimulReport()
            : base(new ReportTemplateBinary(Resources.ChelyabinskProtocol))
        {
        }

        #region Properties
        public string ReportId => "OprRassmComissProtocol197";

        public override string Id
        {
            get { return "OprRassmComissProtocol197"; }
        }
        ...
        {
			get { return "Определение о порядке подготовки к рассмотрению"; }
        }

        public override string Description
        {
			get { return "Определение о порядке подготовки к рассмотрению дела об АП"; }
        }

        public string OutputFileName { get; set; } = "Определение о порядке подготовки к рассмотрению";
        ...
        public override List<TemplateInfo> GetTemplateInfo()
        {
            return new List<TemplateInfo>
            {
                new TemplateInfo
                {
                    Code = "OprRassmComissProtocol197",
                    Name = "OprRassmComissProtocol197",
                    Description = "Определение о порядке подготовки к рассмотрению",
                    Template = Resources.OPRED3_REP197
                }
            };
        }
        ...
        {
			this.CodeTemplate = "OprRassmComissProtocol197";
        }
