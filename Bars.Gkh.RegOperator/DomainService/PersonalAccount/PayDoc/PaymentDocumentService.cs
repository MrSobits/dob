namespace Bars.Gkh.RegOperator.DomainService.PersonalAccount.PayDoc
{
    ...
    public class PaymentDocumentService : IPaymentDocumentService
    {
        ...
        {
            var documentTaskCreater = new DocumentTaskCreater(this.container);
        ...
        public IDataResult SendEmails(BaseParams @params, IProgressIndicator indicator)
        {
            ...
            var smtpClient = appSettings.GetAs<string>("PaymentDocumentSmtpClient");
            var smtpPort = appSettings.GetAs<int>("PaymentDocumentSmtpPort");
            var smtpEmail = appSettings.GetAs<string>("PaymentDocumentSmtpEmail");
            var smtpLogin = appSettings.GetAs<string>("PaymentDocumentSmtpLogin");
            var smtpPassword = appSettings.GetAs<string>("PaymentDocumentSmtpPassword");
