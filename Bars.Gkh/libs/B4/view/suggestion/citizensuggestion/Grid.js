Ext.define('B4.view.suggestion.citizensuggestion.Grid', {
    ...
    title: 'Информация о правонарушениях',
    closable: true,
        ...
        Ext.applyIf(me, {
            ...
            columns: [
                ...
                },
                {
                    ...
                    flex: 1,
                    text: 'Подвид материала',
                    filter: { xtype: 'textfield' }
                },
                {
                    xtype: 'gridcolumn',
                    dataIndex: 'ExecutorZonalInspection',
                    flex: 1,
                    text: 'Административная комиссия',
                    filter: { xtype: 'textfield' }
                },
                //{
                //    xtype: 'gridcolumn',
                ...
                //    flex: 1,
                //    text: 'Почтовый адрес административной комиссии',
                //    filter: { xtype: 'textfield' }
                //},
                {
                    xtype: 'gridcolumn',
