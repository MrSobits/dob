    ...
    public class CourtPracticeViewModel : BaseViewModel<CourtPractice>
    {
        ...
        public override IDataResult List(IDomainService<CourtPractice> domainService, BaseParams baseParams)
        {
            ...
            var data = domainService.GetAll()
                ...
                { 
                    ...
                    x.ContragentPlaintiff,
                    x.ContragentDefendant,
                    x.TypeFactViolation,
        ...
        public override IDataResult Get(IDomainService<CourtPractice> domain, BaseParams baseParams)
        {
            ...
            var data = new
               {
                dataCp.Id,
                ContragentDefendant = dataCp.ContragentDefendant != null ? new { dataCp.ContragentDefendant.Id, dataCp.ContragentDefendant.Name } : null,
                ContragentPlaintiff = dataCp.ContragentPlaintiff != null ? new { dataCp.ContragentPlaintiff.Id, dataCp.ContragentPlaintiff.Name } : null,
                dataCp.CourtCosts,
