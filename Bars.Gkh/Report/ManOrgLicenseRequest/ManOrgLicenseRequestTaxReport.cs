    ...
    public class ManOrgLicenseRequestTaxReport : GkhBaseStimulReport
    {
        ...
        public override void PrepareReport(ReportParams reportParams)
        {
            ...
            try
            {
                ...
                Report["ДлФио"] = first.Person.FullName;
                Report["ДлПаспорт"] = string.Format("{0} {1} {2} {3:dd.MM.yyyy}", first.Person.IdSerial, first.Person.IdNumber, first.Person.IdIssuedBy, first.Person.IdIssuedDate);
            }
            finally
            {
