Ext.define('B4.aspects.ComissionMeetingButtonPrintAspect', {
    extend: 'B4.base.Aspect',

    alias: 'widget.comissionmeetingbuttonprintaspect',
    ...
    init: function (controller) {
        ...
        this.reportStore = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                autoLoad: false,
                type: 'ajax',
                url: B4.Url.action('/ComissionMeetingReport/GetReportList'),
                reader: {
                    type: 'json',
                    root: 'data'
                }
            ...
            Ext.Msg.prompt({
                ...
                fn: function (btnId, text) {
                    if (btnId === 'ok') {
                        ...
                        B4.Ajax.request({
                            url: B4.Url.action('MassReportPrint', 'ComissionMeetingReport'),
                            params: me.params,
                            timeout: 9999999
                        }).next(function (resp) {
                            var tryDecoded;
