namespace Bars.GkhGji.Regions.Voronezh.Controllers
{
    ...
    public class AppealCitsAdmonitionSignController : BaseController
    {
        ...
        public AppealCitsAdmonitionSignController(IFileManager fileManager, IDomainService<B4.Modules.FileStorage.FileInfo> fileDomain)
        {
        ...
        public ActionResult GetXML(BaseParams baseParams)
        {
            ...
            Response.AddHeader("Content-Disposition", "inline; filename=passport.pdf");
            ...
            using (var tr = Resolve<IDataTransaction>())
            {
                ...
                try
                {
                    ...
                    if (string.Compare(entity.File.Extention, "docx", true) == 0 || string.Compare(entity.File.Extention, "doc", true) == 0)
                    {
                        ...
                        if (docGen.TrySetPicture("$_ЭП_$", picStrm, 225, 99))
                        {
