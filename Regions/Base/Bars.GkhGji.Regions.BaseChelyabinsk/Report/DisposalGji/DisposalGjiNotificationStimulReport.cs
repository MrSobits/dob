namespace Bars.GkhGji.Regions.BaseChelyabinsk.Report.DisposalGji
{
    ...
    public class DisposalGjiNotificationStimulReport : GjiBaseStimulReport
    {
        ...
        {
            get { return "Уведомление о вызове на комиссию"; }
        }
        ...
        public override void PrepareReport(ReportParams reportParams)
        {
            ...
            try
            {
                ...
                this.Report["DispId"] = this.DocumentId;
                ...
                {
                    this.Report.RegData("ОтветственныйЗаИсполнение", new
                    {
            ...
            return new List<TemplateInfo>
                       {
                           new TemplateInfo
                           {
                                   ...
                                   Description = "Уведомление о вызове на комиссию",
