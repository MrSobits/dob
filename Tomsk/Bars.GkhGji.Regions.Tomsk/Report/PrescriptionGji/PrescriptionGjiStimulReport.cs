    ...
    public class PrescriptionGjiStimulReport : GjiBaseStimulReport
    {
        ...
        public override void PrepareReport(ReportParams reportParams)
        {
            ...
            try
            {
                ...
                Report["ПричинаИнспектирования"] = string.Empty;
                ...
                if (documentGji.TypeDocumentGji == TypeDocumentGji.Disposal)
                {
                    ...
                    if (disposal.KindCheck != null)
                    {
                        ...
                        {
                            Report["ПричинаИнспектирования"] = "плановая проверка";
                        }
                        ...
                        {
                            Report["ПричинаИнспектирования"] = "обращение жильцов";
                        }
                    }
                }
                ...
                Report["ПиН"] = strCodePin.ToString();
        ...
        private void FillNormativeDocItems(IEnumerable<long> violationIds)
        {
            ...
            Report["ПереченьНарушенныхНПА"] = violNormDocItemsSB.ToStr();
        }
        ...
        private void FillRoInfo(Prescription prescription)
        {
            ...
            try
            {
                ...
                Report["УправляющаяОрганизация"] = manOrgs.Any() ? String.Join(", ", manOrgs) : "Отсутствует";
                ...
                Report["ХарактеристикаОбъекта"] = characteristic;
        ...
        private void FillContragentInfo(Prescription prescription)
        {
            ...
            if (contragent != null)
            {
                ...
                Report["АдресКонтрагентаФакт"] = contragent != null
                ...
                if (contragent.FiasJuridicalAddress != null)
                {
                    ...
                    Report["АдресКонтрагентаЮр"] = newAddr.ToString();
                }
