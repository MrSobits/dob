namespace Bars.Gkh.Decisions.Nso.Domain.Impl
{
    ...
    class LogMonthlyFeeAmountDecisionServiceService : ILogMonthlyFeeAmountDecisionService
    {
        /// <summary>
        /// Провайдер сессии
        /// </summary>
        ...
        /// <summary>
        /// Домен сервис "Размер ежемесячного взноса на КР"
        /// </summary>
        public IDomainService<MonthlyFeeAmountDecision> Service { get; set; }
        ...
        {
            var monthlyFeeAmountDecision = this.Service.Get(entity.Id);
