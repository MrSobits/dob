Ext.define('B4.controller.claimwork.Lawsuit', {
    ...
    aspects: [
        ...
        },
        {
            ...
            codeForm: 'CourtClaimOwner, CourtClaimOwner185, CourtClaimOwner512, LawSuitOwnersPetition, ExecutiveClaim, ExecutiveClaimRepeat',
            getUserParams: function () {
                var me = this,
                    view = me.controller.getMainView(),
    ...
    init: function () {
        ...
        actions['clwlawsuitmaininfopanel button[action=DebtStartCalculate]'] =
            { click: me.calculateDebtStartMainDate, scope: me }
    ...
    calculateDebtStartDate: function (btn) {
        ...
        B4.Ajax.request({
            url: B4.Url.action('DebtStartDateCalculateChelyabinsk', 'LawsuitOwnerInfo'),
            method: 'POST',
            timeout: 100 * 60 * 60 * 3,
            params: {
                docId: docId
    ...
    calculateDebtStartMainDate: function(btn) {
        var me = this;
        debugger;
        view = me.getMainView();
