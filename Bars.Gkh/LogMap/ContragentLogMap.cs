namespace Bars.Gkh.LogMap
{
    ...
    public class ContragentLogMap : AuditLogMap<Contragent>
    {
        public ContragentLogMap()
        {
            ...
            // ContragentState
            this.MapProperty(x => x.ContragentState, "ContragentState", "Статус", x => x.GetDisplayName());
            ...
            // GroundsTermination
            this.MapProperty(x => x.ActivityGroundsTermination, "ActivityGroundsTermination", "Основание прекращения деятельности", x => x.GetDisplayName());
            ...
            this.MapProperty(x => x.TypeEntrepreneurship, "TypeEntrepreneurship", "Тип предпринимательства", x => x.GetDisplayName());
        }
    }
}
