namespace Bars.Gkh.Decisions.Nso.Domain
{
    ...
    public interface IRealityObjectDecisionsService
    {
        ...
        Dictionary<long, IGrouping<long, T>> GetActualDecisions<T>(List<long> realityObjectIds) where T : UltimateDecision;
        ...
        /// <returns></returns>
        Dictionary<long, IEnumerable<Tuple<DateTime, CrFundFormationDecisionType>>> GetRobjectsFundFormation(IQueryable<long> roIds = null);
