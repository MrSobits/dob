        ...
        private XElement GetRequestEGRN(SMEVEGRN requestData)
        {
            ...
            if (!string.IsNullOrEmpty(requestData.CadastralNUmber))
            {
                switch (requestData.RequestType)
                {
                    ...
                    //            )),
                    //    break;
                    case Enums.Egrn.RequestType.requestEGRNDataAction:
            ...
            switch (requestData.RequestType)
            {
                case Enums.Egrn.RequestType.requestCopyAction:
                ...
                case Enums.Egrn.RequestType.requestEGRNDataAction:
                    ...
                    break;
                case Enums.Egrn.RequestType.requestEGRNAccessAction:
            ...
            var result = new XElement(tns + "EGRNRequest", new XAttribute("_id", "GZHI_" + requestData.Id),
                ...
                new XElement(tns + "declarant",
                    ...
                    new XElement(subj + "other",
                        new XElement(subj + "name", "Государственная Административная комиссия Воронежской области"),
