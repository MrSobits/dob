namespace Bars.GkhGji
{
    ...
    public partial class ResourceManifest
    {
        protected override void AdditionalInit(IResourceManifestContainer container)
        {
            ...
            container.Add("libs/B4/enums/TypeFormInspection.js", new ExtJsEnumResource<TypeFormInspection>("B4.enums.TypeFormInspection"));
            container.Add("libs/B4/enums/TypeAgreementProsecutor.js", new ExtJsEnumResource<TypeAgreementProsecutor>("B4.enums.TypeAgreementProsecutor"));
            ...
            container.Add("libs/B4/enums/FormCheck.js", new ExtJsEnumResource<FormCheck>("B4.enums.FormCheck"));
            ...
            container.RegisterExtJsEnum<ComissionDocumentDecision>();            
            container.RegisterExtJsEnum<MessageCheck>();
            container.RegisterExtJsEnum<PlaceOffense>();
            container.RegisterExtJsEnum<TypeViolator>();
            container.RegisterExtJsEnum<FamilyStatus>();
            container.RegisterExtJsEnum<OmsRegionBelonging>();
        }
    }
}