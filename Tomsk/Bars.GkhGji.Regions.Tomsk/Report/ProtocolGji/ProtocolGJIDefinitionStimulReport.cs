namespace Bars.GkhGji.Regions.Tomsk.Report.ProtocolGji
{
    ...
    public class ProtocolGjiDefinitionStimulReport : GkhBaseStimulReport
    {
        ...
        public override void PrepareReport(ReportParams reportParams)
        {
            ...
            Report["Правонарушитель"] = contrName;
            //Report["Контрагент"] = contrName;

            Report["ИнспекторТворП"] =
            ...
            if (articles != null)
            {
                ...
                Report["ОписаниеСтатьи"] = !string.IsNullOrEmpty(atrDescription)
            ...
            Report["МестоРассмотрения"] = definition.PlaceReview;
