        ...
        public bool CreateReminders(B4.Utils.DynamicDictionary dict, out string message)
        {
            ...
            try
            {
                ...
                /*
                    ...
                    1) у которых вид санкции не административный штраф (Код 1)
                    2) Без Суммы штрафа
                    3) Без должностного лица 
                    4) Сумма штрафа < суммы всех оплат 
                    5) из которых создан протокол, у которого во вкладке «Статьи закона» указана статья с кодом 10.
                 */
                ...
                using (var tr = Container.Resolve<IDataTransaction>())
                {
                    ...
                    {
                        tr.Rollback();
                        Container.Resolve<ILogManager>().Error("Создание напоминалок с типом Постановление", exp);
                        return false;
                    }
                }
