Ext.define('B4.controller.Disposal', {
    ...
    views: [
       ...
       'disposal.SurveyObjectiveGrid',
        ...
        'disposal.action.BaseDisposalWindow',
        'disposal.action.HistoryWindow'
    ],
    ...
    aspects: [
        ...
        //{
        //    xtype: 'gkhbuttonhistoryaspect',
        //    name: 'disposalHistoryAspect',
        //    buttonSelector: '#disposalEditPanel #btnHistory',
        //    codeForm: 'Disposal',
...

        {
            ...
            */
            ...
            modelName: 'Disposal',
            listeners: {
                onBeforeload: function (asp, record) {
                    resolution = record.getId();
                    debugger;
                }
            },
            otherActions: function (actions) {
                ...
                actions[this.editPanelSelector + ' #cbTypeViolator'] = { 'change': { fn: this.onChangeViolator, scope: this } };
                actions[this.editPanelSelector + ' #btnHistory'] = { 'click': { fn: this.onHistoryClick, scope: this } };
            },


            onHistoryClick: function (btn) {
               // this.controller.params.individualpersonid = 
                var panel = this.getPanel(),
                    individualpersonid = panel.down('textfield[name=IndividualPersonId]'),
                    win = Ext.widget('historywindow');
                win.individualpersonid = individualpersonid.value;
                win.show();
            },

            onChangeViolator: function (field, newValue) {
                var panel = this.getPanel(),
                    transport = panel.down('#sfTransport'),
                ...
                if (newValue == B4.enums.TypeViolator.PhisicalPerson) {
                    ...
                    PassportSeries.setValue(null);
                    PassportNumber.setValue(null);
                    PassportIssued.setValue(null);
                    DateIssue.setValue(null);
                    DepartmentCode.setValue(null);
                    DateBirth.setValue(null);
                    BirthPlace.setValue(null);
                    Job.setValue(null);
                    PlaceResidence.setValue(null);
                    ActuallyResidence.setValue(null);
                }
            ...
            onAfterSetPanelData: function (asp, rec, panel) {
                ...
                if (asp.controller.params) {
                  ...
                  //  asp.controller.params.municipalityId = record.data.Municipality.Id;
                }
                ...
                B4.Ajax.request({
                    ...
                    var toattracted = panel.down('#cbToAttracted');
                    if (obj.toattracted == true) {
                        toattracted.setValue(true);
                    }
                    else
                    {
                        toattracted.setValue(false);
                    }
                    debugger;
                ...
                me.controller.getStore('disposal.Violation').load();
        ...
        },
        {
            ...
            */
            ...
            columnsGridSelect: [
                ...
                { header: 'Подразделение', xtype: 'gridcolumn', dataIndex: 'Description', flex: 1, filter: { xtype: 'textfield' } }
            ],
            columnsGridSelected: [
        ...
        },
        {
            ...
            */
            ...
            columnsGridSelect: [
                { header: 'Наименование', xtype: 'gridcolumn', dataIndex: 'Name', flex: 1, filter: { xtype: 'textfield' } },
                { header: 'Пункт НПД', xtype: 'gridcolumn', dataIndex: 'NormDocNum', flex: 1, filter: { xtype: 'textfield' } }
            ],
            columnsGridSelected: [
                { header: 'Наименование', xtype: 'gridcolumn', dataIndex: 'Name', flex: 1, sortable: false }
            ],
            ...
            onBeforeLoad: function (store, operation) {
                var record = this.controller.getAspect('disposalEditPanelAspect').getRecord();
                operation.params.municipalityId = record.data.Municipality;
            },

            //onBeforeLoad: function (store, operation, asp) {
            //    var record = this.controller.getAspect('disposalEditPanelAspect').getRecord();
            //    municipalityId: record.data.Municipality.Id;
            //    //B4.Ajax.request(B4.Url.action('ListViolationforMunicipality', 'DisposalViol', {
            //    //    municipalityId: record.data.Municipality.Id
            //    //})).next(function (response) {
            //    //    asp.controller.unmask();
        ...
        //            if (recordIds[0] > 0) {
        //                asp.controller.mask('Сохранение', asp.controller.getMainComponent());
        //                B4.Ajax.request(B4.Url.action('AddViolations', 'DisposalViol', {
        //                    expertIds: recordIds,
        //                    documentId: asp.controller.params.documentId
        //                })).next(function (response) {
        //                    asp.controller.unmask();
    ...
    init: function () {
        ...
        me.getStore('disposal.Violation').on('beforeload', me.onBeforeLoad, me);
    ...
    onBeforeLoad: function (store, operation) {
        ...
        disposalid = this.params.documentId;
        operation.params.municipalityId = this.params.municipalityId;
    },
