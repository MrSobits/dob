namespace Bars.Gkh.Gis.DomainService.CalcVerification.Impl
{
    ...
    public class CalcVerificationService : ICalcVerificationService
    {
        ...
        public ListDataResult<ChargeProxyOut> Delta(ChargeProxyIn chargeIn, DeltaParams Params)
        {
            ...
            var result = listing
                .Select(x => new ChargeProxyOut
                {
                    ...
                    ChargeDate = x.dat_charge.IsNullOrEmpty()
                                     ? (DateTime?)null
            ...
            if (!Params.ShowNulls)
            {
                ...
                return new ListDataResult<ChargeProxyOut>(listResult, 0);
            }
            return new ListDataResult<ChargeProxyOut>(result, 0);
        }
