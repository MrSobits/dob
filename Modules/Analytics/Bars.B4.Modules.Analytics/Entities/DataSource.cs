namespace Bars.B4.Modules.Analytics.Entities
{
    ...
    public class DataSource : BaseEntity, IDataSource
    {
        ...
        public virtual byte[] DataFiletrBytes
        {
            ...
            set { DataFilter = JsonConvert.DeserializeObject<DataFilter>(Encoding.Default.GetString(value)); }
        }
        ...
        public virtual byte[] SystemFilterBytes
        {
            ...
            set { SystemFilter = JsonConvert.DeserializeObject<SystemFilter>(Encoding.Default.GetString(value)); }
        }
