namespace Bars.Gkh.Overhaul.Tat.Interceptors
{
    ...
    public class ShortProgramRecordInterceptor : EmptyDomainInterceptor<ShortProgramRecord>
    {
        ...
        {
            // Удалять можно только работы и только те котоыре добавлен в ручную
            if (entity.Work.TypeWork == TypeWork.Service || entity.TypeDpkrRecord != TypeDpkrRecord.UserRecord)
            {
