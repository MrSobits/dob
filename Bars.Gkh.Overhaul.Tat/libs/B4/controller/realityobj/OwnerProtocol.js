    ...
    aspects: [
        ...
        },
        {
            ...
            onChangeTypeProtocol: function (fld, newValue) {
                var win = fld.up('window'),
                    disabled = newValue == 20,
                    isLoanProtocol = newValue == 30;

                win.down('[name=NumberOfVotes]').setDisabled(disabled || isLoanProtocol);
                win.down('[name=TotalNumberOfVotes]').setDisabled(disabled || isLoanProtocol);
                win.down('[name=PercentOfParticipating]').setDisabled(disabled || isLoanProtocol);
