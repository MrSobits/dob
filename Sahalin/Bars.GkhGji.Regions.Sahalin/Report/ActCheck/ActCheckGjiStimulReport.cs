    ...
    public class ActCheckGjiStimulReport : GjiBaseStimulReport
    {
        ...
        public override void PrepareReport(ReportParams reportParams)
        {
            ...
            try
            {
                ...
                Report.RegData("АктПроверки", actCheckInfo);
                ...
                if (act.Inspection.Contragent != null)
                {
                    ...
                    Report.RegData("Контрагенты", contragents);
                }
                ...
                if (disposal != null)
                {
                    ...
                    Report.RegData("Приказ", disposalInfo);
                }
                ...
                Report.RegData("ЛицаПрисутствующиеНаПроверке", witness);
                ...
                Report.RegData("ПредоставленныеДокументы", actProvidedDocs);
	            ...
	            {
		            Report["ВремяСоставленияАкта"] = actCheckTime.DateEnd != null
				...
				Report["ОбщаяПродолжительностьПроверки"] = ConvertDuration(totalTime);
				...
				Report.RegData("ДатаИВремяПроведенияПроверки", actCheckPeriodsForReport);
            }
            finally
            {
