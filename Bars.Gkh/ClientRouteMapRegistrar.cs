...
namespace Bars.Gkh
{
    public class ClientRouteMapRegistrar: IClientRouteMapRegistrar
    {
        public void RegisterRoutes(ClientRouteMap map)
        {
            ...
            map.AddRoute(new ClientRoute("dotmapgkh/{id}", "B4.controller.suggestion.YandexBuildContractMap"));
            ...
            map.AddRoute(new ClientRoute("individualperson", "B4.controller.dict.IndividualPerson", requiredPermission: "Gkh.Dictionaries.IndividualPerson.View"));
