namespace Bars.Gkh.Overhaul.Hmao
{
    ...
    public partial class Module : AssemblyDefinedModule
    {
        public override void Install()
        {
            ...
            this.Container.RegisterTransient<IFakePublicationService, FakePublicationService>();

            Container.RegisterSingleton<IActualizeDPKRService, ActualizeDPKRService>();
            Container.RegisterSingleton<IActualizeSubrecordService, ActualizeSubDPKRService>();
        ...
        {
            this.Container.RegisterTaskExecutor<EconFesabilityCalcTaskExecutor>(EconFesabilityCalcTaskExecutor.Id);
            this.Container.RegisterTaskExecutor<BindKPKRandDPKRTaskExecutor>(BindKPKRandDPKRTaskExecutor.Id);
        }
        ...
        {
            this.Container.RegisterTransient<IDataExportService, EconFeasibilityCalcResultExport>("EconFeasibilityCalcResultExport");
            ...
            this.Container.RegisterTransient<IDataExportService, PropertyOwnerProtocolsExport>("PropertyOwnerProtocolsExport");
        ...
        private void RegisterControllers()
        {
            ...
            this.Container.RegisterAltDataController<PropertyOwnerProtocolsDecision>();
            this.Container.RegisterController<PropertyOwnerProtocolInspectorController>();
            this.Container.RegisterController<PropertyOwnerProtocolsOperationsController>();
            ...
            this.Container.RegisterFileStorageDataController<PropertyOwnerProtocolsDecision>();
            ...
            this.Container.RegisterController<EconFesabilityCalcController>();
            
            //Расчет целесообразности
            this.Container.RegisterAltDataController<EconFeasibilityCalcResult>(); 
            this.Container.RegisterAltDataController<EconFeasibilitiWork>();
            ...
            this.Container.RegisterAltDataController<MaxSumByYear>();
            this.Container.RegisterAltDataController<SubProgramCriterias>();

            this.Container.RegisterController<ActualizeDPKRController>();
            this.Container.RegisterController<ActualizeSubDPKRController>();
        }
        ...
        private void RegisterViewModels()
        {
            ...
            this.Container.RegisterViewModel<PropertyOwnerProtocolsDecision, PropertyOwnerProtocolsDecisionViewModel>();
            ...
            Container.RegisterViewModel<MaxSumByYear, MaxSumByYearViewModel>();
            Container.RegisterViewModel<SubProgramCriterias, SubProgramCriteriasViewModel>();

            this.Container.RegisterViewModel<EconFeasibilityCalcResult, EconFeasibilityCalcResultViewModel>();
            this.Container.RegisterViewModel<EconFeasibilitiWork, EconFeasibilityCalcResultWorkViewModel>();
        }
        ...
        private void RegisterServices()
        {
            ...
            this.Container.RegisterTransient<IMakeKPKRFromDPKRService, MakeKPKRFromDPKRService>();
            ...
            this.Container.RegisterTransient<IAddVersionRecord, AddVersionRecord>();
            this.Container.RegisterTransient<ICostService, CostService>();
        ...
        private void RegisterDomainServices()
        {
            ...
            this.Container.RegisterTransient<IPropertyOwnerProtocolInspectorService, PropertyOwnerProtocolInspectorService>();

            this.Container.RegisterDomainService<PropertyOwnerProtocolsDecision, FileStorageDomainService<PropertyOwnerProtocolsDecision>>();
        ...
        private void RegisterInterceptors()
        {
            ...
            this.Container.RegisterDomainInterceptor<MaxSumByYear, MaxSumByYearInterceptor>();
            ...
            this.Container.RegisterDomainInterceptor<SubProgramCriterias, SubProgramCriteriasInterceptor>();
        ...
        private void RegisterExecutionActions()
        {
            ...
            this.Container.RegisterExecutionAction<BindKPKRandDPKRAction>();
