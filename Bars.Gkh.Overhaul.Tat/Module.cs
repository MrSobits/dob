namespace Bars.Gkh.Overhaul.Tat
{
    ...
    public partial class Module : AssemblyDefinedModule
    {
        ...
        {
            ContainerHelper.ReplaceProxySelectorService<KapremProtocolossProxy,
                Bars.Gkh.RegOperator.FormatDataExport.ProxySelectors.Impl.KapremProtocolossSelectorService,
                KapremProtocolossSelectorService>(this.Container);
            ...
            //    ProtocolossSelectorService>(this.Container);
        }
    }
}