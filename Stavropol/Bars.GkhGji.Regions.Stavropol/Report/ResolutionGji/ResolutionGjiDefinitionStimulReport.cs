namespace Bars.GkhGji.Regions.Stavropol.Report.ResolutionGji
{
    ...
    public class ResolutionGjiDefinitionStimulReport : GjiBaseStimulReport
    {
        ...
        private void FillCommonInfo()
        {
            ...
            Report["ДатаПостановления"] = _resolution.DocumentDate.HasValue
            ...
            {
                Report["Контрагент"] = _resolution.Contragent.Name;
                Report["КонтрагентСокр"] = _resolution.Contragent.ShortName;
                Report["АдресКонтрагента"] = _resolution.Contragent.FiasJuridicalAddress != null
        ...
        {
            Report["Правонарушитель"] = _resolution.Contragent != null
            ...
            Report["ДатаИВремяРассмотренияДела"] = _definition.ExecutionDate.HasValue
            ...
            if (protocol != null)
            {
                Report["ДатаПротокола"] = protocol.DocumentDate != null
                ...
                using (Container.Using(protocolViolationDomain))
                {
                    ...
                    Report["АдресНарушения"] = realitiObjects;
                }
                ...
                using (Container.Using(docinspDomain))
                {
                    ...
                    if (inspectors.Any())
                    {
                        ...
                        Report["Инспектор"] = firstInspector.FioAblative;
                    }
                }
            }
        }
        ...
        private void FillInstallmentInfo()
        {
            ...
            Report["Штраф"] = _resolution.PenaltyAmount;
        ...
        private void FillDefermentInfo()
        {
            ...
            Report["Штраф"] = _resolution.PenaltyAmount;
            Report["ДатаИсполн"] = _definition.ExecutionDate.HasValue
        ...
        private void FillSuspenseReviewAppealInfo()
        {
            ...
            {
                Report["СтатьяЗакона"] = "в области охраны собственности";
            }
            else if (articles.Any(p => industryActicles.Any(n => p == n)))
            {
                Report["СтатьяЗакона"] = "в промышленности, строительстве и энергетике";
            }
            else if (articles.Any(p => againstOrderArticles.Any(n => p == n)))
            {
                Report["СтатьяЗакона"] = "против порядка управления";
            }
            else if (articles.Any(p => againstPublicOrderArticles.Any(n => p == n)))
            {
                Report["СтатьяЗакона"] = "посягающее на общественный порядок и общественную безопасность";
            }
            ...
            if (_resolution.Contragent != null && _resolution.Executant != null)
            {
                ...
                if (contragent != null)
                {
                    Report["Контрагент"] = contragent;
                }
                if (contragentAddress != null)
                {
                    Report["АдресКонтрагента"] = contragentAddress;
                }
                if (withRespect != null)
                {
            ...
            using (Container.Using(docinspDomain))
            {
                ...
                {
                    var firstInspector = inspectors.First();
                    Report["РуководительФИО"] = firstInspector.ShortFio;
                }
            }
            ...
            if (_definition.ExecutionDate.HasValue)
            {
                ...
                Report["ДатаИВремяРассмотренияДела"] = string.Format("{0:dd MMMM yyyy} в {0:HH} час. {0:mm} мин.",
                    executionDate);
            }
        }
