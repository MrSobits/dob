namespace Bars.Gkh.RegOperator.Map.Import
{
    ...
    public class ChesImportNhMapping : ClassMapping<ChesImport>
    {
        ...
        {
            this.Property(x => x.LoadedFiles, m => m.Type<JsonSerializedType<SortedSet<FileType>>>());
            this.Property(x => x.ImportedFiles, m => m.Type<JsonSerializedType<SortedSet<FileType>>>());
        }
    }
}