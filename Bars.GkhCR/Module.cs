namespace Bars.GkhCr
{
    ...
    using Bars.GkhCr.DomainService.GisGkhRegional.Impl;
    ...
    using Bars.GkhCr.Services.Impl;
    ...
    public partial class Module : AssemblyDefinedModule
    {
        public override void Install()
        {
            ...
            this.Container.RegisterTransient<IRuleChangeStatus, MassBuildContractRule>();
            this.Container.RegisterTransient<IRuleChangeStatus, CrObjectBuildContractRule>();

            this.RegisterControllers();


            // this.Container.RegisterTransient<IGkhBaseReport, OverhaulProposalReport>("OverhaulProposalReport");
            ...
            this.Container.RegisterTransient<IGkhBaseReport, OverhaulProposalReport>();

            #region ViewModel
            this.Container.RegisterViewModel<TypeWorkCrHistory, TypeWorkCrHistoryViewModel>();
            //предложения по капремонту
            this.Container.RegisterViewModel<OverhaulProposal, OverhaulProposalViewModel>();
            this.Container.RegisterViewModel<OverhaulProposalWork, OverhaulProposalWorkViewModel>();
            //
            ...
            this.Container.RegisterViewModel<HousekeeperReport, HousekeeperReportViewModel>();
            this.Container.RegisterViewModel<HousekeeperReportFile, HousekeeperReportFileViewModel>();
            ...
            this.Container.RegisterViewModel<ArchiveMultiplyContragentSmr, ArchiveMultiplyContragentSmrViewModel>();
            this.Container.RegisterViewModel<BuildControlTypeWorkSmr, BuildControlTypeWorkSmrViewModel>();
            this.Container.RegisterViewModel<BuildControlTypeWorkSmrFile, BuildControlTypeWorkSmrFIleViewModel>();
            #endregion
            ...
            this.Container.RegisterDomainService<BuildControlTypeWorkSmrFile, FileStorageDomainService<BuildControlTypeWorkSmrFile>>();
            this.Container.RegisterDomainService<HousekeeperReportFile, FileStorageDomainService<HousekeeperReportFile>>();
            ...
            this.Container.RegisterDomainService<ObjectCr, FileStorageDomainService<ObjectCr>>();
            ...
            this.Container.RegisterDomainService<MassBuildContract, FileStorageDomainService<MassBuildContract>>();
            ...
            this.Container.RegisterDomainInterceptor<PSDWorks, PSDWorksInterceptor>();
            this.Container.RegisterDomainInterceptor<DesignAssignmentTypeWorkCr, DesignAssignmentTypeWorkCrInterceptor>();
            ...
            this.Container.RegisterDomainInterceptor<ArchiveMultiplyContragentSmr, ArchiveMultiplyContragentSmrInterceptor>();
            ...
            this.Container.RegisterDomainInterceptor<HousekeeperReport, HousekeeperReportServiceInterceptor>();
            ...
            this.Container.RegisterDomainInterceptor<CrFileRegister, CrFileRegisterInterceptor>();
            //Предложение КР
            this.Container.RegisterDomainInterceptor<OverhaulProposal, OverhaulProposalServiceInterceptor>();
            //Массовые договора
            this.Container.RegisterDomainInterceptor<MassBuildContract, MassBuildContractServiceInterceptor>();
            this.Container.RegisterDomainInterceptor<MassBuildContractObjectCr, MassBuildContractObjectCrServiceInterceptor>();
            this.Container.RegisterDomainInterceptor<BuildControlTypeWorkSmr, BuildControlTypeWorkSmrInterceptor>();
            #endregion
            ...
            this.Container.RegisterImport<PerformedWorkImport>(PerformedWorkImport.Id);
            #endregion
        ...
        {
            this.Container.RegisterController<CrFileRegisterController>();

            this.Container.RegisterController<MenuObjectCrController>();
            this.Container.RegisterController<PhotoArchivePrintController>();
            this.Container.RegisterAltDataController<TypeWorkCrAddWork>();
            this.Container.RegisterAltDataController<WorksCrInspection>();
            this.Container.RegisterAltDataController<HousekeeperReport>();
            this.Container.RegisterAltDataController<HousekeeperReportFile>();


            this.Container.RegisterAltDataController<ArchiveMultiplyContragentSmr>();
            this.Container.RegisterAltDataController<BuildControlTypeWorkSmr>();
            this.Container.RegisterAltDataController<BuildControlTypeWorkSmrFile>();

            this.Container.RegisterAltDataController<Official>();
            this.Container.RegisterAltDataController<PSDWorks>();

            //Предложения по капремонту
            this.Container.RegisterAltDataController<OverhaulProposal>();
            this.Container.RegisterAltDataController<OverhaulProposalWork>();
            ...
            // массовые договора
            this.Container.RegisterAltDataController<MassBuildContract>();
            this.Container.RegisterAltDataController<MassBuildContractObjectCr>();
            this.Container.RegisterAltDataController<MassBuildContractObjectCrWork>();
            this.Container.RegisterAltDataController<MassBuildContractWork>();
            this.Container.RegisterFileStorageDataController<MassBuildContract>();    
            Container.RegisterTaskExecutor<MassBuildContractTaskExecutor>(MassBuildContractTaskExecutor.Id);
            Container.RegisterTaskExecutor<CrFileRegisterTaskExecutor>(CrFileRegisterTaskExecutor.Id);
        ...
        private void CreateStatesForPir()
        {
            ...
            this.Container.CreateStates<BuildContractClaimWork>(states, x => !x.Name.StartsWith("Utility"));
        }
        ...
        private void RegisterExports()
        {
            ...
            this.Container.RegisterTransient<IDataExportService, OverhaulProposalDataExport>("OverhaulProposalDataExport");
        ...
        private void RegisterServices()
        {
            ...
            this.Container.RegisterTransient<ICrFileRegisterService, CrFileRegisterService>();
        }
        ...
        private void RegisterViewModels()
        {
            ...
            //Массовые договора
            this.Container.RegisterViewModel<MassBuildContract, MassBuildContractViewModel>();
            this.Container.RegisterViewModel<MassBuildContractObjectCr, MassBuildContractObjectCrViewModel>();
            this.Container.RegisterViewModel<MassBuildContractObjectCrWork, MassBuildContractObjectCrWorkViewModel>();
            this.Container.RegisterViewModel<MassBuildContractWork, MassBuildContractWorkViewModel>();

            this.Container.RegisterTransient<IJurJournalType, JurJournalBuildContractType>();
            this.Container.RegisterViewModel<TypeWorkCrAddWork, TypeWorkCrAddWorkViewModel>();
            this.Container.RegisterViewModel<CrFileRegister, CrFileRegisterViewModel>();
        }
