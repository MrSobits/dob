	...
	public class NsoProtocolStimulReport : GjiBaseStimulReport
    {
        ...
        public override void PrepareReport(ReportParams reportParams)
        {
            ...
            try
            {
                ...
                Report.RegData("СоставлениеПротокола", protocolData);
                ...
                Report.RegData("Реквизиты", requisite);
                ...
                Report.RegData("Инспектор", inspectorInfo);
                ...
                Report.RegData("ДокументВыдан", documentIssued);
                ...
                Report.RegData("ПереченьТребований", survSubjReq);
                ...
                Report.RegData("УведомлениеОСоставлении", notif);
                ...
                Report.RegData("Рассмотрение", proceed);
                ...
                Report.RegData("ЗамечанияНарушителя", remarks);
                ...
                Report.RegData("Нарушения", violations);
                ...
                Report.RegData("СведенияОНарушении", violData);
                ...
                Report.RegData("СтатьиЗакона", articles);
                ...
                Report.RegData("Приложения", annex);
                ...
                Report.RegData("СведенияСвидетельствущиеАктПроверки", actCheckPersonViolInfo);
                ...
                Report.RegData("СведенияСвидетельствущиеАктПроверкиПредписания", actRemovalPersonViolInfo);
                ...
                Report.RegData("Деятельность", baseDoc);
                ...
                Report.RegData("Приказ", disposalData);
                ...
                Report.RegData("АктПроверки", achtCheckData);
                ...
                Report.RegData("Предписание", prescriptionData);
                ...
                Report.RegData("ВыполнениеПредписания", prescrActRemovalViol);
                ...
                Report.RegData("ПриказНаПроверкуПредписания", dispRemovalData);
                ...
                Report.RegData("АктПроверкиПредписания", actRemovalData);
