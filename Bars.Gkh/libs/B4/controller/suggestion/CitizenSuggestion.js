Ext.define('B4.controller.suggestion.CitizenSuggestion', {
    ...
    aspects: [
        ...
        },
        {
            ...
            otherActions: function (actions, me) {
                actions['citizensuggestionwindow button[name=btnMap]'/* this.editFormSelector + '#btnMap'*/] = { 'click': { fn: this.onClickbtnMap, scope: this } };
                ...
                actions['citizensuggestionwindow b4selectfield[name="ExecutorZonalInspection"]'] = { 'change': { fn: this.onExecutorZonalInspectionChange, scope: this } };
                actions['citizensuggestionwindow b4selectfield[name="Inspector"]'] = { 'beforeload': { fn: this.onBeforeLoadInspector, scope: this } };
            },
            onClickbtnMap: function () {
                var me = this;
                me.controller.application.redirectTo(Ext.String.format('dotmapgkh/{0}', skId));
            },
            onBeforeLoadInspector: function (store, operation) {
                operation.params.zonalInspectionId = zonalInspection.Id;
            },
            onExecutorZonalInspectionChange: function (field, newValue) {
                zonalInspection = newValue;
            },
            ...
            onExportToGjiClick: function(btn) {
                ...
                asp.controller.mask('Экспорт в реестр оБращений', asp.controller.getMainComponent());
                B4.Ajax.request({
                    method: 'POST',
                    ...
                    B4.QuickMsg.msg('Экспорт в реестр оБращений', 'Данные успешно экспортированы', 'success');
                    btn.setDisabled(true);
                    asp.controller.unmask();
                }).error(function (resp) {
                    B4.QuickMsg.msg('Экспорт в реестр оБращений', resp.message || 'При экспорте данных возникла ошибка', 'error');
                    asp.controller.unmask();
                });
