...
Ext.define('B4.controller.objectcr.Protocol', {
    ...
    aspects: [
        ...
        },
        {
            ...
            name: 'protocolTypeWorkMultiSelectWindowAspect',
            fieldSelector: 'objectcrprotocolwin #trigTypeWorks',
            multiSelectWindow: 'SelectWindow.MultiSelectWindow',
            multiSelectWindowSelector: '#protocolTypeWorkSelectWindow',
            ...
            onBeforeLoad: function (store, operation) {
                if (this.controller.params) {
                    operation.params.objectCrId = asp.controller.getContextValue(asp.controller.getMainComponent(), 'objectcrId');
                }
            },
            listeners: {
                getdata: function (asp, records) {
                    var recordIds = [],
                        protocolCrId = asp.controller.getContextValue(asp.controller.getMainComponent(), 'protocolId');
                    ...
                    if (recordIds[0] > 0) {
                        ...
                        B4.Ajax.request(B4.Url.action('AddTypeWorks', 'ProtocolCr', {
                            objectIds: recordIds,
                            protocolCrId: protocolCrId
                        })).next(function () {
                            asp.controller.unmask();
                            return true;
                        }).error(function () {
    ...
    init: function () {
        ...
        me.control({
            ...
            'objectcrprotocolwin protocoltypeworkcrgrid b4updatebutton': {
                click: function (btn) {
                    var grid = btn.up('protocoltypeworkcrgrid');
