Ext.define('B4.ux.form.SchedulerPanel', {
                    ...
                    items: [
                        {
                            ...
                            items: [
                                { boxLabel: 'Однократно', inputValue: 0, checked: true },
    ...
    getRecord: function (record) {
        ...
        record.set('PeriodType', values.PeriodType);
        record.set('StartNow', values.StartNow);
        record.set('StartDate', values.StartDate);
        record.set('EndDate', values.EndDate);
        record.set('StartTimeHour', values.StartTimeHour);
        record.set('StartTimeMinutes', values.StartTimeMinutes);
        record.set('StartDayOfWeekList', values.StartDayOfWeekList);
        record.set('StartMonthList', values.StartMonthList);
        record.set('StartDaysList', values.StartDaysList);
