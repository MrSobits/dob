    ...
    public class GkhPermissionMap : PermissionMap
    {
        ...
        public GkhPermissionMap()
        {
            ...
            */
            ...
            this.Namespace("Gkh.Dictionaries.IndividualPerson", "Нарушители");
            this.CRUDandViewPermissions("Gkh.Dictionaries.IndividualPerson");
            ...
            this.Permission("Reports.GKH.ManOrgLicenseRequestManOrgLicenseRequestOrderReport", "Материалы правонарушения");
