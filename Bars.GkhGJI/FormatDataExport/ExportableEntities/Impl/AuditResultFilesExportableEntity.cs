namespace Bars.GkhGji.FormatDataExport.ExportableEntities.Impl
{
    ...
    /// </summary>
    public class AuditResultFilesExportableEntity : BaseExportableEntity<ActCheck>
    {
        /// <inheritdoc />
        ...
        {
            var exportData = this.ProxySelectorFactory.GetSelector<ActCheckFilesProxy>()
            ...
            return this.AddFilesToExport(exportData, x => x.File)
                .Select(x => new ExportableRow(
                    ...
                    new List<string>
                    {
                        ...
                        x.DocumentGjiId.ToStr(), // 2. Акт проверки
