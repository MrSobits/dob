﻿namespace Bars.GkhGji.Regions.Chelyabinsk.StateChange
{
    ...
    public class AppealSOPRStateRule : IRuleChangeStatus
    {
        ...
        {          
            ...
            body += $"Главное управление Государственная Административная комиссия  Челябинской области сообщает Вам, что обращение {appeal.NumberGji} от {appeal.DateFrom.Value.ToShortDateString()} передано Вам для оперативного исполнения и размещено в реестре СОПР АИС ГЖИ Челябинской области.\r\n";
            return body;
        }
