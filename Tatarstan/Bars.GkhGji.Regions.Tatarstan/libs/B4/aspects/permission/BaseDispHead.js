Ext.define('B4.aspects.permission.BaseDispHead', {
    ...
    permissions: [
        ...
        { name: 'GkhGji.Inspection.BaseDispHead.Field.RegistrationNumber_View', applyTo: '[name=RegistrationNumber]', selector: '#baseDispHeadEditPanel' },
        { name: 'GkhGji.Inspection.BaseDispHead.Field.RegistrationNumber_Edit', applyTo: '[name=RegistrationNumber]', selector: '#baseDispHeadEditPanel' },
        { name: 'GkhGji.Inspection.BaseDispHead.Field.RegistrationNumberDate_View', applyTo: '[name=RegistrationNumberDate]', selector: '#baseDispHeadEditPanel' },
        { name: 'GkhGji.Inspection.BaseDispHead.Field.RegistrationNumberDate_Edit', applyTo: '[name=RegistrationNumberDate]', selector: '#baseDispHeadEditPanel' },
        { name: 'GkhGji.Inspection.BaseDispHead.Field.CheckDayCount_View', applyTo: '[name=CheckDayCount]', selector: '#baseDispHeadEditPanel' },
        { name: 'GkhGji.Inspection.BaseDispHead.Field.CheckDayCount_Edit', applyTo: '[name=CheckDayCount]', selector: '#baseDispHeadEditPanel' },
