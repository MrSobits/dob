    ...
    public class PrescriptionGjiStimulReport : GjiBaseStimulReport
    {
        ...
        public override void PrepareReport(ReportParams reportParams)
        {
            ...
            try
            {
                ...
                Report["УправОрг"] = prescription.Contragent != null ? prescription.Contragent.Name : string.Empty;
                Report["КомуВыдано"] = string.Empty;
                if (prescription.Executant != null)
                {
                    ...
                    switch (prescription.Executant.Code)
                    {
                        ...
                        case "8":
                        case "18":
                            Report["КомуВыдано"] = "{0} {1}".FormatUsing(executant.Дательный, shortName);
                            break;
                        case "10":
                        case "1":
                        case "3":
                        case "5":
                        case "19":
                            Report["КомуВыдано"] = "{0} {1} {2}".FormatUsing(executant.Дательный, shortName, physicalPerson.Дательный);
                            break;
                        case "6":
                        case "7":
                            Report["КомуВыдано"] = Report["КомуВыдано"] = "{0} {1} {2}".FormatUsing(executant.Дательный, physicalPerson.Дательный,
                ...
                Report["ДолжностьИнспектора"] = headInsp != null ? headInsp.Position : string.Empty;
                Report["КодРуководителяФИО"] = headInsp != null ? headInsp.ShortFio : string.Empty;
                ...
                Report["ДатаАктаПроверки"] = string.Empty;
                if (actDoc != null)
                {
                    Report["НомерАктаПроверки"] = actDoc.DocumentNumber;
                    Report["ДатаАктаПроверки"] = actDoc.DocumentDate.HasValue ? actDoc.DocumentDate.Value.ToString("от dd MMMM yyyy") : string.Empty;
                }
                ...
                {
                    Report["ДомаИАдреса"] = listRealityObjs.AggregateWithSeparator(", ");
                }
            }
