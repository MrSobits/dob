namespace Bars.Gkh.RegOperator.DomainService.PersonalAccount
{
    ...
    public class PersonalAccountGroupService : IPersonalAccountGroupService
    {
        ...
        public ListDataResult<PersAccGroup> ListGroupsByAccount(BaseParams baseParams)
        {
            ...
            return new ListDataResult<PersAccGroup>(data.Order(loadParams).Paging(loadParams).ToList(), count);
        }
