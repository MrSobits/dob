namespace Bars.Gkh.RegOperator
{
    ...
    using Bars.Gkh.RegOperator.FormatDataExport.ExportableEntities.Impl;
    ...
    using Bars.Gkh.RegOperator.DataExport;
    ...
    public partial class Module : AssemblyDefinedModule
    {
        ...
        {
            VtbMessageTransformations.ConfigureAutoMapper();
            Bars.Gkh.RegOperator.Entities.Dto.BasePersonalAccountDto.ConfigureAutoMapper();
            ChesMapperConfig.ConfigureAutoMapper();
        }
        ...
        {
            #region tasks
            this.Container.RegisterTaskExecutor<RecalcSaldoExecutor>(RecalcSaldoExecutor.Id);

            this.Container.RegisterTaskExecutor<ExtractMergeTaskExecutor>(ExtractMergeTaskExecutor.Id);
            ...
            this.Container.RegisterTaskExecutor<PaymentDocumentEmailSetTaskExecutor>(PaymentDocumentEmailSetTaskExecutor.Id);
            this.Container.RegisterTaskExecutor<DebtStartCalculateTaskExecutor>(DebtStartCalculateTaskExecutor.Id);
        ...
        private void RegisterCodedReports()
        {
            ...
            this.Container.Register(Component.For<ICodedReport, IClaimWorkCodedReport>().ImplementedBy<LawSuitOwnerDeclarationDirectedReport>().LifestyleTransient());
            ...
            this.Container.Register(Component.For<ICodedReport, IClaimWorkCodedReport>().ImplementedBy<CourtOrderAccountReport>().LifestyleTransient());
            this.Container.Register(Component.For<ICodedReport, IClaimWorkCodedReport>().ImplementedBy<CourtOrderLegalAccountReport>().LifestyleTransient());
            this.Container.Register(Component.For<ICodedReport, IClaimWorkCodedReport>().ImplementedBy<CourtOrderSharedOwnershipReport>().LifestyleTransient());
            this.Container.Register(Component.For<ICodedReport, IClaimWorkCodedReport>().ImplementedBy<CourtOrderSharedOwnershipDirectedReport>().LifestyleTransient());
            this.Container.Register(Component.For<ICodedReport, IClaimWorkCodedReport>().ImplementedBy<CourtOrderUnderageReport>().LifestyleTransient());
            this.Container.Register(Component.For<ICodedReport, IClaimWorkCodedReport>().ImplementedBy<CourtOrderUnderageDirectedReport>().LifestyleTransient());
            this.Container.Register(Component.For<ICodedReport, IClaimWorkCodedReport>().ImplementedBy<LawSuitSharedOwnershipReport>().LifestyleTransient());
            this.Container.Register(Component.For<ICodedReport, IClaimWorkCodedReport>().ImplementedBy<LawSuitUnderageReport>().LifestyleTransient());
            this.Container.Register(Component.For<ICodedReport, IClaimWorkCodedReport>().ImplementedBy<ExecutiveClaimReport>().LifestyleTransient());
            this.Container.Register(Component.For<ICodedReport, IClaimWorkCodedReport>().ImplementedBy<CourtOrderPr>().LifestyleTransient());
            this.Container.Register(Component.For<ICodedReport, IClaimWorkCodedReport>().ImplementedBy<CourtOrderPrMulti>().LifestyleTransient());
            this.Container.Register(Component.For<ICodedReport, IClaimWorkCodedReport>().ImplementedBy<ExecutiveClaimReportRepeat>().LifestyleTransient());
        ...
        private void RegisterDomainServices()
        {
            ...
            //this.Container.RegisterTransient<IDomainService<IndividualAccountOwner>, IndividualAccountDomainService>();
            //this.Container.RegisterTransient<IDomainService<IndividualAccountOwner>, FileStorageDomainService<IndividualAccountOwner>>();
            //this.Container.Register(Component.For<IDomainService<IndividualAccountOwner>>().ImplementedBy<FileStorageDomainService<IndividualAccountOwner>>().LifeStyle.Transient);
            //this.Container.RegisterFileStorageDomainService<IndividualAccountOwner>();
        ...
        private void RegisterViewModels()
        {
            ...
            //Справочник для эталонных начислений
        ...
        private void RegisterControllers()
        {
            ...
            this.Container.RegisterController<FileStorageDataController<IndividualAccountOwner>>();
            ...
            this.Container.RegisterController<DRosRegExtractMergerController>();
        ...
        private void RegisterExecutionActions()
        {
            ...
            this.Container.RegisterExecutionAction<RecalcSaldoAction>();
        ...
        private void RegisterExports()
        {
            ...
            Container.Register(Component.For<IDataExportService>().Named("BankAccountStatementDataExport").ImplementedBy<BankAccountStatementDataExport>().LifeStyle.Transient);
        ...
        private void RegisterPersonalAccountOperations()
        {
            ...
            this.Container.RegisterTransient<IPersonalAccountOperation, SetSignOperation>(SetSignOperation.Key);
        }
        ...
        private void RegisterFormatDataExport()
        {
            ...
            ContainerHelper.RegisterExportableEntity<EpdChargeExportableEntity>(this.Container);
            ...
            ContainerHelper.RegisterProxySelectorService<KapremProtocolossProxy, KapremProtocolossSelectorService>(this.Container);
            ...
            ContainerHelper.ReplaceProxySelectorService<PremisesProxy,
                Gkh.FormatDataExport.ProxySelectors.Impl.PremisesSelectorService,
                PremisesSelectorService>(this.Container);

            ContainerHelper.ReplaceProxySelectorService<DomProxy,
                Gkh.FormatDataExport.ProxySelectors.Impl.DomSelectorService,
                DomSelectorService>(this.Container);

            ContainerHelper.ReplaceProxySelectorService<ContragentRschetProxy,
                Overhaul.FormatDataExport.ProxySelectors.Impl.ContragentRschetSelectorService,
                ContragentRschetSelectorService>(this.Container);
        }
