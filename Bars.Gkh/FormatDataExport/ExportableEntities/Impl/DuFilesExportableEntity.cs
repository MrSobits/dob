namespace Bars.Gkh.FormatDataExport.ExportableEntities.Impl
{
    ...
    /// </summary>
    public class DuFilesExportableEntity : BaseExportableEntity<ManOrgContractOwners>
    {
        private int id = 1;
        ...
        {
            return this.GetFiles(x => x.OssFile, 4)
                .Union(this.GetFiles(x => x.DuFile, 1))
                .Union(this.GetFiles(x => x.OwnerFile, 8))
                .ToList();
        }
        ...
        {
            var contracts = this.ProxySelectorFactory.GetSelector<DuProxy>().ProxyListCache.Values;
