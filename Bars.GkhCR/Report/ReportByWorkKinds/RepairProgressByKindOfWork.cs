namespace Bars.GkhCr.Report.ReportByWorkKinds
{
    ...
    public class RepairProgressByKindOfWork : BasePrintForm
    {
        ...
        public override string Name
        {
            get
            {
                return "Отчет по видам работ (сравнение с программой КР по 100% работам)";
            }
        }
        ...
        public override string ParamsController
        {
            get
            {
                return "B4.controller.report.RepairProgressByKindOfWork";
            }
        }
        ...
        public override string RequiredPermission
        {
            get
            {
                return "Reports.CR.RepairProgressByKindOfWork";
            }
        }
