namespace Bars.GkhGji.Permissions
{
    ...
    public class GkhGjiPermissionMap : PermissionMap
    {
        ...
        public GkhGjiPermissionMap()
        {
            ...
            this.Namespace("GkhGji.Comissions", "Комиссии");
            this.Namespace<ComissionMeeting>("GkhGji.Comissions.ComissionMeeting", "Заседания комиссий");
            this.CRUDandViewPermissions("GkhGji.Comissions.ComissionMeeting");

            #region Документы ГЖИ
            this.Namespace<DocumentGji>("GkhGji.DocumentsGji", "Документы комиссии");
            ...
            */
            ...
            this.Permission("GkhGji.AppealCitizens.CheckBoxShowCloseApp", "Показать закрытые обращения");
            ...
            this.Namespace("GkhGji.Dict.ArticleLaw", "Статьи закона");
            ...
            this.Namespace("GkhGji.Dict.Subpoena", "Повестка на комиссию");
            this.CRUDandViewPermissions("GkhGji.Dict.Subpoena");
            ...
            #region Отчеты
            this.Namespace("Reports.GJI", "Модуль комиссии");
            ...
            this.Permission("Reports.GJI.ControlDocGjiExecution", "Контроль исполнения документов");
            this.Permission("Reports.GJI.FillDocumentsGji", "Отчет \"Заполнение данных в Реестре\"");
            ...
            this.Permission("Reports.GJI.GjiWork", "Работа комиссии за период");
