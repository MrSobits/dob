        ...
        public override void ExecuteResult(ControllerContext context)
        {
            switch (ResultCode)
            {
                case ResultCode.Success:
                    ...
                    context.HttpContext.Response.AddHeader("Content-Disposition", "inline; filename=\"" + normalizedFileName + "\"");
                    ...
                    if (Data != null)
                    {
                        context.HttpContext.Response.AddHeader("Content-Length", Data.Length.ToString(CultureInfo.InvariantCulture));
