...
namespace Bars.GkhGji.Regions.Voronezh.DomainService
{
    public class SMEVRedevelopmentService : ISMEVRedevelopmentService
    {
        ...
        {
            SGIO.SMEVRedevelopment.RequestType requestType = new SGIO.SMEVRedevelopment.RequestType
            {
        ...
        private XElement GetRequestElement(SGIO.SMEVRedevelopment.RequestType request)
        {
