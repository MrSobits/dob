namespace Bars.GkhDi.Regions.Tatarstan.DomainService
{
    ...
    public class ServTatService : ServService
    {
        ...
        protected override void InitWorkRepairList(List<long> periodIds, InitParams initParams, List<long> realityObjIds = null)
        {
        ...
        protected override void InitWorkRepairDetail(List<long> periodIds, ServService.InitParams initParams, List<long> realityObjIds = null)
            {
