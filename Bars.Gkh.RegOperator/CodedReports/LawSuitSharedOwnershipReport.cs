namespace Bars.Gkh.RegOperator.CodedReports
{
    ...
    public class LawSuitSharedOwnershipReport : ExportFormatHelper, IClaimWorkCodedReport
    {
        ...
        public override string Name => "Исковое заявление (совместная собственность нужная)";
        ...
        public string OutputFileName { get; set; } = "Исковое заявление (совместная собственностьнужная)";
