namespace Bars.Gkh
{
    ...
    public partial class ResourceManifest
    {
        ...
        {
            container.Add("libs/SignalR/Hubs.js", new SignalrHubsResource());
        ...
        private void RegisterEnums(IResourceManifestContainer container)
        {
            ...
            container.RegisterExtJsEnum<YesNoNotSetPartially>();
            ...
            container.RegisterExtJsEnum<TypeCommissionMember>();
