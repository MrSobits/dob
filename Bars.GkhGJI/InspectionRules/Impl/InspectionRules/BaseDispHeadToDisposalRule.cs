namespace Bars.GkhGji.InspectionRules
{
    ...
    /// </summary>
    public class BaseDispHeadToDisposalRule : IInspectionGjiRule
    {
        ...
        public virtual IDataResult CreateDocument(InspectionGji inspection)
        {
            ...
            disposal.IssuedDisposal = head.Head;
            disposal.TypeViolator = GetTypeViolator(head.PersonInspection);
            disposal.Contragent = head.Contragent;
            #endregion
        ...
        private TypeViolator GetTypeViolator(PersonInspection personInspection)
        {
            switch (personInspection)
            {
                case PersonInspection.Official:
                    return TypeViolator.OfficialPerson;
                case PersonInspection.IP:
                    return TypeViolator.IP;
                case PersonInspection.Organization:
                    return TypeViolator.UridicalPerson;
                case PersonInspection.PhysPerson:
                    return TypeViolator.PhisicalPerson;
                case PersonInspection.RealityObject:
                    return TypeViolator.PhisicalPerson;
            }
            return TypeViolator.PhisicalPerson;
        }
