namespace Bars.Gkh.FormatDataExport.ExportableEntities.Impl
{
    ...
    /// </para>
    /// </summary>
    public class LiftExportableEntity : BaseExportableEntity<Entrance>
    {
        /// <inheritdoc />
        ...
        protected override IList<ExportableRow> GetEntityData()
        {
            var entranceNumberCache = this.TehPassportCacheService.GetCacheByRealityObjectsAndRows(LiftExportableEntity.LiftForm, 1)
                .Where(x => this.FilterService.RealityObjectIds.Contains(x.RealityObjectId))
                .ToList();
            ...
            var entranceDict = this.EntityRepository.GetAll()
                .Select(x => new
                {
                    x.Id,
