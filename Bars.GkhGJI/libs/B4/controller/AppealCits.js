    ...
    aspects: [
        ...
        },
        {
            ...
            */
            ...
            columnsGridSelect: [
                { header: 'Номер', xtype: 'gridcolumn', dataIndex: 'NumberGji', flex: 1, filter: { xtype: 'textfield' } },
                { header: 'Дата обращения', xtype: 'datecolumn', dataIndex: 'DateFrom', flex: 1, filter: { xtype: 'datefield', operand: CondExpr.operands.eq } }
            ],
            columnsGridSelected: [
                { header: 'Номер', xtype: 'gridcolumn', dataIndex: 'NumberGji', flex: 1, sortable: false },
                { header: 'Дата обращения', xtype: 'datecolumn', dataIndex: 'DateFrom', flex: 1, filter: { xtype: 'datefield', operand: CondExpr.operands.eq } }
            ],
        ...
        },
        {
            ...
            */
            ...
            otherActions: function(actions) {
                ...
                {
                    'beforeload': { fn: this.onBeforeLoadRealityObject, scope: this }, 
                    'change': { fn: this.onChangeRealityObject, scope: this }
                };
            },
            ...
            onChangeRealityObject: function(filed, newValue) {
                ...
                if (newValue && sfContragent && cbTypeJurPerson && cbTypeJurPerson.getValue() == B4.enums.TypeJurPerson.ManagingOrganization) {
