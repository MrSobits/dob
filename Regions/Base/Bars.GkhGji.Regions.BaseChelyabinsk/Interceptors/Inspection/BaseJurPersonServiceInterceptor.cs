    ...
    public class BaseJurPersonServiceInterceptor : BaseJurPersonServiceInterceptor<BaseJurPerson>
    {
        ...
        private bool Validation(IDomainService<BaseJurPerson> service, BaseJurPerson entity, out string message)
        {
            ...
            /*
                ...
                <Дата начала осуществления деятельности> - брать "Дату начала деятельности" из уведомления о начале предпринимательской деятельности юрлица (Административная комиссия - Реестр уведомлений - Реестр уведомлений о начале)
