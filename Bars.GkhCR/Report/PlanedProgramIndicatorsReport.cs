namespace Bars.GkhCr.Report
{
    ...
    public class PlanedProgramIndicatorsReport : BasePrintForm
    {
        ...
        {
            get { return "Планирумые показатели выполнения программы КР"; }
        }
        ...
        {
            get { return "B4.controller.report.PlanedProgramIndicators"; }
        }
        ...
        public override void PrepareReport(ReportParams reportParams)
        {
            ...
            var objectCrDict = GetObjectCrDict(objectCrService, typeWorkCrService);
        ...
        /// <returns></returns>
        protected virtual Dictionary<MunicipalityDataProxy, Record> GetObjectCrDict(IDomainService<ObjectCr> objectCrService, IDomainService<TypeWorkCr> typeWorkCrService)
        {
            return objectCrService.GetAll()
                .WhereIf(municipalityListId.Length > 0, x => municipalityListId.Contains(x.RealityObject.MoSettlement.Id))
