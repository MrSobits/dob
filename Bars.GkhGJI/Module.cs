namespace Bars.GkhGji
{
    ...
    public partial class Module : AssemblyDefinedModule
    {
        ...
        private void RegisterControllers()
        {
            ...
            this.Container.RegisterAltDataController<MKDLicRequest>();
          ...
          //  this.Container.RegisterAltDataController<Subpoena>();
            this.Container.RegisterController<SubpoenaController>();
            ...
            this.Container.RegisterController<ViolationGjiMunicipalityController>();
            ...
            Container.RegisterController<ComissionMeetingOperationController>();
            ...
            this.Container.RegisterAltDataController<ComissionMeetingDocument>();
            ...
            // нарушитель 
            this.Container.RegisterAltDataController<Transport>();
            this.Container.RegisterAltDataController<TransportDisposal>();
            this.Container.RegisterAltDataController<Owner>();

            //Комиссия
            this.Container.RegisterAltDataController<ComissionMeeting>();
            this.Container.RegisterAltDataController<ComissionMeetingInspector>();
            ...
            this.Container.RegisterController<ComissionMeetingReportController>();
        }
        ...
        private void RegisterDomainService()
        {
            ...
            this.Container.RegisterTransient<IComissionMeetingReportService, ComissionMeetingReportService>();

            this.Container.RegisterTransient<IComissionMeetingOperationService, ComissionMeetingOperationService>();
        ...
        private void RegisterViewModels()
        {
            ...
            //комиссии
            this.Container.Register(Component.For<IViewModel<ComissionMeeting>>().ImplementedBy<ComissionMeetingViewModel>().LifeStyle.Transient);
            this.Container.Register(Component.For<IViewModel<ComissionMeetingInspector>>().ImplementedBy<ComissionMeetingInspectorViewModel>().LifeStyle.Transient);
            ...
            //основания проверок
            this.Container.Register(Component.For<IViewModel<BaseActivityTsj>>().ImplementedBy<BaseActivityTsjViewModel>().LifeStyle.Transient);
            this.Container.Register(Component.For<IViewModel<BaseHeatSeason>>().ImplementedBy<BaseHeatSeasonViewModel>().LifeStyle.Transient);
            this.Container.Register(Component.For<IViewModel<BaseDispHead>>().ImplementedBy<BaseDispHeadViewModel>().LifeStyle.Transient);
            this.Container.Register(Component.For<IViewModel<BaseProsClaim>>().ImplementedBy<BaseProsClaimViewModel>().LifeStyle.Transient);
            this.Container.Register(Component.For<IViewModel<BaseDefault>>().ImplementedBy<BaseDefaultViewModel>().LifeStyle.Transient);
            this.Container.Register(Component.For<IViewModel<BaseJurPerson>>().ImplementedBy<BaseJurPersonViewModel>().LifeStyle.Transient);
            this.Container.Register(Component.For<IViewModel<BaseInsCheck>>().ImplementedBy<BaseInsCheckViewModel>().LifeStyle.Transient);
            this.Container.Register(Component.For<IViewModel<BaseStatement>>().ImplementedBy<BaseStatementViewModel>().LifeStyle.Transient);
            ...
            this.Container.Register(Component.For<IViewModel<ViolationGjiMunicipality>>().ImplementedBy<ViolationGjiMunicipalityViewModel>().LifeStyle.Transient);
            ...
            this.Container.Register(Component.For<IViewModel<Subpoena>>().ImplementedBy<SubpoenaViewModel>().LifeStyle.Transient);
            ...
            // Нарушитель 
            this.Container.RegisterViewModel<Owner, OwnerViewModel>();
   
            this.Container.RegisterViewModel<TransportDisposal, TransportDisposalViewModel>();
            this.Container.RegisterViewModel<Transport, TransportViewModel>();
            this.Container.RegisterViewModel<OwnerRoom, OwnerRoomViewModel>();
            ...
            Container.RegisterViewModel<OSP, OSPViewModel>();

           // this.Container.RegisterViewModel<ViolationGjiMunicipality, ViolationGjiMunicipalityViewModel>();
        ...
        private void RegisterService()
        {
            ...
            this.Container.Register(Component.For<IViolationGjiMunicipality>().ImplementedBy<ViolationGjiMunicipalityService>().LifeStyle.Transient);
            ...
            this.Container.Register(Component.For<ISubpoena>().ImplementedBy<SubpoenaService>().LifeStyle.Transient);
            // Распоряжение
            ...
            this.Container.Register(Component.For<IResolutionOperationProvider>().ImplementedBy<ResolutionOperationProvider>().LifeStyle.Transient);
            this.Container.RegisterTransient<IPersonalResolutionOperation, SumAmountOperation>(SumAmountOperation.Key);
            this.Container.RegisterTransient<IPersonalResolutionOperation, Create2025Operation>(Create2025Operation.Key);
            this.Container.RegisterTransient<IPersonalResolutionOperation, ChangeOSPOperation>(ChangeOSPOperation.Key);
            this.Container.RegisterTransient<IPersonalResolutionOperation, ChangeSentToOSPOperation>(ChangeSentToOSPOperation.Key);
        ...
        {
            this.Container.Register(Component.For<IDomainServiceInterceptor<ComissionMeeting>>().ImplementedBy<ComissionMeetingInterceptor>().LifeStyle.Transient);
            this.Container.Register(Component.For<IDomainServiceInterceptor<Subpoena>>().ImplementedBy<SubpoenaInterceptor>().LifeStyle.Transient);
            ...
            this.Container.Register(Component.For<IDomainServiceInterceptor<BaseStatement>>().ImplementedBy<BaseStatementServiceInterceptor>().LifeStyle.Transient);
            ...
            this.Container.RegisterDomainInterceptor<Owner, OwnerInterceptor>();
            ...
            this.Container.RegisterDomainInterceptor<ResolutionDefinition, ResolutionDefinitionInterceptor>();
        }
        ...
        private void RegisterReports()
        {
            ...
            this.Container.Register(Component.For<IGkhBaseReport, IComissionMeetingCodedReport>().ImplementedBy<ProtocolGjiNotificationReport>().LifestyleTransient());
            this.Container.Register(Component.For<IGkhBaseReport, IComissionMeetingCodedReport>().ImplementedBy<Protocol2025DebtReport>().LifestyleTransient());
        ...
        private void RegisterFormatDataExport()
        {
            ...
            ContainerHelper.RegisterProxySelectorService<ActCheckFilesProxy, ActCheckFilesSelectorService>(this.Container);
            ContainerHelper.RegisterProxySelectorService<DisposalFilesProxy, DisposalFilesSelectorService>(this.Container);
