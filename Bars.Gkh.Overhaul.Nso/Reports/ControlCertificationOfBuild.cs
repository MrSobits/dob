namespace Bars.Gkh.Overhaul.Nso.Reports
{
    ...
    public class ControlCertificationOfBuild : BasePrintForm
    {
        ...
        public override void PrepareReport(ReportParams reportParams)
        {
            ...
            var manOrgByRoIdDict = this.Container.Resolve<IDomainService<ManOrgContractRealityObject>>().GetAll()
            ...
            var realtyObjByMuDict = this.Container.Resolve<IDomainService<RealityObject>>().GetAll()
