...
namespace Bars.GkhGji.Map
{
    ...
    public class ResolutionDefinitionMap : BaseEntityMap<ResolutionDefinition>
    {
        ...
        protected override void Map()
        {
            ...
            Property(x => x.ConciderationDate, "Дата рассмотрения на комиссии").Column("CONCIDERATION_DATE");
            ...
            Reference(x => x.ComissionMeeting, "Заседание комиссии").Column("COMISSION_MEETING_ID").Fetch();
        }
    }
}
