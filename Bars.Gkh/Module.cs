namespace Bars.Gkh
{
    ...
    public partial class Module : AssemblyDefinedModule
    {
        ...
        public override void Install()
        {
            ...
            this.Container.Register(Component.For<GkhCache>().ImplementedBy<GkhCache>().LifeStyle.SessionScoped());
        ...
        {
            this.Container.Register(
                Component.For<IStateRepository>().ImplementedBy<StateRepository>().LifeStyle.SessionScoped(),
                Component.For<ILawsuitRepository>().ImplementedBy<LawsuitRepository>().LifeStyle.SessionScoped());
        }
        ...
        private void RegisterController()
        {
            ...
            // физ лицо 
            //this.Container.RegisterAltDataController<IndividualPerson>();
            ...
            this.Container.RegisterController<IndividualPersonController>();
        ...
        private void RegisterServices()
        {
            ...
            Container.RegisterTransient<ICSCalculationOperationsService, CSCalculationOperationsService>();
            ...
            this.Container.RegisterTransient<IRealityObjectImageService, RealityObjectImageService>();
        ...
        private void RegisterViewModels()
        {
            ...
            // Физ лицо  
            this.Container.RegisterViewModel<IndividualPerson, IndividualPersonViewModel>();
            // BelayManOrgActivity
    ...
    public static class AutoMapperConfigurator
    {
        ...
        {
            Mapper.CreateMap<FiasAddress, Utils.Utils.FiassHouseProxy>()
