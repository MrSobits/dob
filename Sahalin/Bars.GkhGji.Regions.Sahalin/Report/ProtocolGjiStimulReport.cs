        ...
        public override void PrepareReport(ReportParams reportParams)
        {
            ...
            try
            {
                ...
                if (protocol.Contragent != null)
                {
                    ...
                    Report.RegData("Контрагенты", contragent);
                }
                ...
                Report.RegData("СтатьяЗакона", articles);
                ...
                Report.RegData("Протокол", protocolProxy);

                Report["ТипИсполнителя"] = protocol.Executant != null ? protocol.Executant.Code : string.Empty;
