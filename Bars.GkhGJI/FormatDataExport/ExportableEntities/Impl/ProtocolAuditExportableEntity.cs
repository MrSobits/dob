namespace Bars.GkhGji.FormatDataExport.ExportableEntities.Impl
{
    ...
    /// Протоколы проверки
    /// </summary>
    public class ProtocolAuditExportableEntity : BaseExportableEntity<Protocol>
    {
        /// <summary>
        /// Нарушения
        /// </summary>
        public IRepository<ProtocolViol> ProtocolViolRepositoryViolRepository { get; set; }
        ...
        {
            var violationDict = this.ProtocolViolRepositoryViolRepository.GetAll()
            ...
            return query.AsEnumerable()
                .Select(x =>
                {
                    ...
                    var stateCode = dateFactRemoval != null ? "1" : "2";
