...
namespace Bars.GkhGji.Map
{
    ...
    public class PrescriptionViolMap : JoinedSubClassMap<PrescriptionViol>
    {
        ...
        public PrescriptionViolMap() : 
                base("Этап указания к устранению нарушения в предписании", "GJI_PRESCRIPTION_VIOLAT")
        {
        }
        
        protected override void Map()
        {
            Property(x => x.Action, "Мероприятие по устранению").Column("ACTION").Length(4000);
