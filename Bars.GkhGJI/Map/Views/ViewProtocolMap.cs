...
namespace Bars.GkhGji.Map
{
    ...
    public class ViewProtocolMap : PersistentObjectMap<ViewProtocol>
    {
        ...
        protected override void Map()
        {
            ...
            Property(x => x.DateViolation, "Дата правонарушения").Column("DATE_VIOLATION");
            Property(x => x.InspectorPosition, "Должность инспектора").Column("INSPECTOR_POSITION");
            Property(x => x.ToCourt, "Направлено в суд").Column("TO_COURT");
            Property(x => x.JudSectorName, "Судебный участок").Column("JUD_SECTOR_NAME");
