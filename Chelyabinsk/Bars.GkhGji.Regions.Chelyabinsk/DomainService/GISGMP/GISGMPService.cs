...
namespace Bars.GkhGji.Regions.Chelyabinsk.DomainService
{
    public class GISGMPService : IGISGMPService
    {
        ...
        static XNamespace bdiNamespace = @"http://roskazna.ru/gisgmp/xsd/BudgetIndex/2.2.0";
        static XNamespace orgNamespace = @"http://roskazna.ru/gisgmp/xsd/Organization/2.2.0";
        static XNamespace comNamespace = @"http://roskazna.ru/gisgmp/xsd/Common/2.2.0";
        static XNamespace chgNamespace = @"http://roskazna.ru/gisgmp/xsd/Charge/2.2.0";
        static XNamespace pkgNamespace = @"http://roskazna.ru/gisgmp/xsd/Package/2.2.0";
        static XNamespace reqNamespace = @"urn://roskazna.ru/gisgmp/xsd/services/import-charges/2.2.0";
        static XNamespace rfdNamespace = @"http://roskazna.ru/gisgmp/xsd/Refund/2.2.0";
        static XNamespace pmntNamespace = @"http://roskazna.ru/gisgmp/xsd/Payment/2.2.0";
        static XNamespace ns0Namespace = @"urn://roskazna.ru/gisgmp/xsd/services/export-payments/2.2.0";
        static XNamespace scNamespace = @"http://roskazna.ru/gisgmp/xsd/SearchConditions/2.2.0";
        static XNamespace faNamespace = "urn://roskazna.ru/gisgmp/xsd/services/forced-ackmowledgement/2.2.0";
        ...
        private XElement GetPayRequestByPayerIdentifierXML(GisGmp requestData)
        {
            ...
            var result = new XElement(ns0Namespace + "ExportPaymentsRequest",
                ...
                new XElement(scNamespace + "PaymentsExportConditions",
                    ...
                    new XElement(scNamespace + "PayersConditions",
                        new XElement(scNamespace + "PayerIdentifier", requestData.AltPayerIdentifier
                        ),
                         new XElement(comNamespace + "TimeInterval",
                         new XAttribute("startDate", requestData.GetPaymentsStartDate.HasValue ? requestData.GetPaymentsStartDate.Value.ToString("yyyy-MM-ddT00:00:00+05:00") : DateTime.Now.AddDays(-10).ToString("yyyy-MM-ddT00:00:00+05:00")),
                         new XAttribute("endDate", requestData.GetPaymentsEndDate.HasValue ? requestData.GetPaymentsEndDate.Value.ToString("yyyy-MM-ddT00:00:00+05:00") : DateTime.Now.AddDays(-10).ToString("yyyy-MM-ddT00:00:00+05:00"))
                        )
                    //  new XElement(scNamespace + "KBK", requestData.PaymentKBK
                    //)
                    )
                )
            );
      ...
      //      result.SetAttributeValue(XNamespace.Xmlns + "bdi", bdiNamespace);
            ...
            var result = new XElement(ns0Namespace + "ExportPaymentsRequest",
                ...
                new XElement(scNamespace + "PaymentsExportConditions",
                    ...
                    new XElement(scNamespace + "ChargesConditions",
                        new XElement(scNamespace + "supplierBillID", requestData.UIN
                        )
                    )
                )
            );
        ...
        private XElement GetReconcileRequestXML(GisGmp requestData)
        {
            ...
            var result = new XElement(faNamespace + "ForcedAcknowledgementRequest",
                new XAttribute("Id", $"ID_{ DateTime.Now.Ticks.ToString() }"),
                new XAttribute("timestamp", DateTime.Now.ToString("o")),
                new XAttribute("senderIdentifier", identifiers.SenderIdentifier),
                new XAttribute("senderRole", identifiers.SenderRole),
                new XElement(faNamespace + "Reconcile",
                    new XAttribute("supplierBillId", uin))
                        );
        ...
        private XElement GetCalcRequestXML(GisGmp requestData)
        {
            ...
            var result = new XElement(reqNamespace + "ImportChargesRequest",
                new XAttribute("Id", $"ID_{ requestData.Id }"),
                new XAttribute("timestamp", DateTime.Now.ToString("o")),
                new XAttribute("senderIdentifier", identifiers.SenderIdentifier),
                new XAttribute("senderRole", identifiers.SenderRole),

                GetChargeOrChange(requestData)
