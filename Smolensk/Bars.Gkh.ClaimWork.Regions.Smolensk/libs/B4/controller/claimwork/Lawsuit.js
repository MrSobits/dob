Ext.define('B4.controller.claimwork.Lawsuit', {
    ...
    aspects: [
        ...
        },
        {
            ...
            getUserParams: function() {
                var me = this,
                    ...
                    codeForm = type === 1 ? 'CourtClaimlegalAccount, CourtOrderPr' : 'CourtClaimAccount, CourtOrderPr',
            ...
            onBeforeLoadReportStore: function(store, operation) {
                var me = this,
                    type = me.controller.getOwnerType();
                operation.params = {};
                operation.params.codeForm = type === 1 ? 'CourtClaimlegalAccount, CourtOrderPr' : 'CourtClaimAccount, CourtOrderPr';
        ...
        },
        {
            ...
            codeForm: 'CourtClaimOwner, CourtClaimShared, CourtClaimUnderage, CourtOrderPrMulti, ExecutiveClaim, ExecutiveClaimRepeat',
            getUserParams: function() {
                var me = this,
                    view = me.controller.getMainView(),
        ...
        },
        {
            ...
            otherActions: function (actions) {
                ...
                //actions['lawsuitdebtworksspeditwindow [name=CbFactInitiated]'] = { 'change': { fn: me.onCbFactInitiatedChanged, scope: me } };
    ...
    index: function (type, id, docId) {
        ...
        //me.getAspect('clwlawsuitcollectionpanel').setData(docId);
