namespace Bars.GkhGji.Regions.Chelyabinsk.Controllers
{
    ...
    public class SendEmailController : BaseController
    {
        ...
        string MakeMessageBody(AppealCits cits)
        {
            ...
            body += $"Главное управление Государственная Административная комиссия  Челябинской области сообщает Вам, что обращение {cits.NumberGji} рассмотрено, файл ответа прикреплен к настоящему электронному сообщению.\r\n";
