        ...
        {   /*
            ...
            */
            ...
            onAfterSetPanelData: function (asp, rec, panel) {
                ...
                //var dfDateToCourt = panel.down('#protocolGjiCourtPanel').down('#dfDateToCourt');
                //var sfJudSector = panel.down('#protocolGjiCourtPanel').down('#sfJudSector');
                //var cbIsFineCharged = panel.down('#protocolGjiCourtPanel').down('#cbIsFineCharged');
                //var dfFineChargeDate = panel.down('#protocolGjiCourtPanel').down('#dfFineChargeDate');
                //var nfChargeAmount = panel.down('#protocolGjiCourtPanel').down('#nfChargeAmount');
                //var nfPaidAmount = panel.down('#protocolGjiCourtPanel').down('#nfPaidAmount');
                //dfDateToCourt.setDisabled(true);
                //sfJudSector.setDisabled(true);
                //cbIsFineCharged.setDisabled(true);
                //dfFineChargeDate.setDisabled(true);
                //nfChargeAmount.setDisabled(true);
                //nfPaidAmount.setDisabled(true);
                //if (rec.get('ToCourt')) {
                //    dfDateToCourt.setDisabled(false);
                //    sfJudSector.setDisabled(false);
                //    cbIsFineCharged.setDisabled(false);
                //    dfFineChargeDate.setDisabled(false);
                //    nfChargeAmount.setDisabled(false);
                //    nfPaidAmount.setDisabled(false);
                //}
                ...
                B4.Ajax.request(B4.Url.action('GetInfo', 'Protocol', {
                    ...
                    var obj = Ext.JSON.decode(response.responseText),
                        ...
                        //fieldpassportseries = panel.down('#dfPhysicalPersonDocumentSerial'),
                        //fieldpassportnumber = panel.down('#dfPhysicalPersonDocumentNumber'),
                        //fieldplaceresidence = panel.down('#tfRegistrationAddress'),
                        //fieldactuallyresidence = panel.down('#tfFactAddress'),
                        //fielddatabirth = panel.down('#tfDatePlaceOfBirth'),
                        sfResolveViolationClaim = panel.down('#sfResolveViolationClaim'),
                        fieldkusp = panel.down('#numberkusp');
                    ...
                    //fieldpassportseries.setValue(obj.PassportSeries);
                    //fieldpassportnumber.setValue(obj.PassportNumber);
                    //fielddatabirth.setValue(obj.DataBirth);
                    //fieldplaceresidence.setValue(obj.PlaceResidence);
                    //fieldactuallyresidence.setValue(obj.ActuallyResidence);
                    fieldkusp.setValue(obj.NumberKUSP);
                ...
                if (typeExec) {
                    ...
                    B4.Ajax.request({
                        ...
                        if (type == 1 || type == 4) {
                            ...
                            sfContragent.allowBlank = false;
                            dfPhysicalPersonDocType.setDisabled(false);
                            tfPhysPerson.setDisabled(false);
                            tfPhysPerson.allowBlank = false;
                            tfPosition.setDisabled(false);
                            tfPosition.allowBlank = false;
                            tfDatePlaceOfBirth.setDisabled(false);
                            tfRegistrationAddress.setDisabled(false);
                            tfFactAddress.setDisabled(false);
                            dfPhysicalPersonDocumentNumber.setDisabled(false);
                            dfPhysicalPersonDocumentSerial.setDisabled(false);
                        ...
                        if (type == 2) {
                            ...
                            dfPhysicalPersonDocType.setDisabled(true);
                            tfPhysPerson.setDisabled(true);
                            tfPhysPerson.allowBlank = true;
                            tfPosition.setDisabled(true);
                            tfPosition.allowBlank = true;
                            tfDatePlaceOfBirth.setDisabled(true);
                            tfRegistrationAddress.setDisabled(true);
                            tfFactAddress.setDisabled(true);
                            dfPhysicalPersonDocumentNumber.setDisabled(true);
        ...
        },
        {
            ...
            */
            ...
            columnsGridSelect: [
                ...
                { xtype: 'b4enumcolumn', enumName: 'B4.enums.TypeCommissionMember', dataIndex: 'TypeCommissionMember', text: 'Тип', flex: 0.5, filter: true }
            ],
            columnsGridSelected: [
