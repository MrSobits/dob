namespace Bars.Gkh.Reforma.Impl.DataCollectors
{
    ...
    public partial class RobjectDataCollector
    {
            ...
            PeriodDi period)
        {
            ...
            var di = this.GetRobjectDisclosure(robject, period);
            ...
            this.FillManagementContract988(result, collectedFiles, robject, reportingPeriod);
       
            this.FillDataByRobjectOverhaul988(result, robject);

            if (di != null)
            {
                this.FillDataByRobjectPassport988(result, di);
                this.FillDataByRobjectAlarm988(result, robject);
        ...
        private void FillDataByRobjectCommonMeetting988(HouseProfileData988 result, List<ICollectedFile<HouseProfileData988>> collectedFiles, DisclosureInfoRealityObj di, ReportingPeriodDict period)
        {
            ...
            try
            {
                var data = documentRoProtocolDomain.GetAll()
                    .Where(x => x.RealityObject.Id == di.RealityObject.Id && x.Year >= di.PeriodDi.DateStart.Value.Year - 1 && x.Year <= di.PeriodDi.DateEnd.Value.Year)
                    .ToList();
            ...
            try
            {
                ...
                houseCommunalServices.AddRange(
                    result.communal_services?
                        .Where(x => new int?[] { 1, 2, 3, 4, 5, 6 }.Except(houseCommunalServices.Select(y => y.type)).Contains(x.type)) 
        ...
        private void FillDataByRobjectStructElements988(HouseProfileData988 result, DisclosureInfoRealityObj di)
        {
            ...
            result.floor_type = null;
            if (structElements.TypeFloor != null)
            {
                switch (structElements.TypeFloor.ToLower())
                {
                    case "железобетонные":
                        result.floor_type = 1;
                        break;
            ...
            result.wall_material = null;
            if (structElements.TypeWalls != null)
            {
                switch (structElements.TypeWalls.ToLower())
                {
                    case "кирпичный":
                        result.wall_material = 1;
                        break;
                    case "панельный":
                        result.wall_material = 2;
                        break;
                    case "монолит":
                        result.wall_material = 6;
                        break;
                    default:
                        result.wall_material = 7;
                        break;
                }
            }
            ...
            result.chute_type = 1;
            if (!string.IsNullOrEmpty(structElements.ConstructionChute))
            {
                switch (structElements.ConstructionChute.ToLower())
                {
                    case "квартирные":
                        result.chute_type = 2;
                        break;
                    case "обособленные помещения на лесничной клетке":
                    case "лестничная клетка":
                        result.chute_type = 3;
                        break;
                }
            }
        ...
        private void FillDataByRobjectEngineerSystems988(HouseProfileData988 result, DisclosureInfoRealityObj di)
        {
            ...
            result.electrical_type = null;
            if (engineerSystems.TypePower != null)
            {
                switch (engineerSystems.TypePower.ToLower())
                {
                    case "отсутствует":
                        result.electrical_type = 1;
                        break;
                    case "центральное":
                        result.electrical_type = 2;
                        break;
                    case "комбинированное":
                        result.electrical_type = 3;
                        break;
                }
            }
            ...
            result.heating_type = null;
            if (engineerSystems.TypeHeating != null)
            {
                switch (engineerSystems.TypeHeating.ToLower())
                {
                    case "отсутствует":
                        result.heating_type = 1;
                        break;
                    case "центральное":
                        result.heating_type = 2;
                        break;
                    case "автономная котельная (крышная, встроенно-пристроенная)":
                        result.heating_type = 3;
                        break;
                    case "квартирное отопление (квартирный котел)":
                        result.heating_type = 4;
                        break;
                    case "печное":
                        result.heating_type = 5;
                        break;
                }
            }

            result.hot_water_type = null;
            if (engineerSystems.TypeHotWater != null)
            {
                switch (engineerSystems.TypeHotWater.ToLower())
                {
                    case "отсутствует":
                        result.hot_water_type = 1;
                        break;
                    case "центральное":
                        result.hot_water_type = 2;
                        break;
                    case "автономная котельная (крышная, встроенно-пристроенная)":
                        result.hot_water_type = 4;
                        break;
                    case "квартирное отопление (квартирный котел)":
                        result.hot_water_type = 5;
                        break;
                    case "индивидуальный водонагреватель":
                        result.hot_water_type = 3;
                        break;
                    case "печное":
                        result.hot_water_type = 6;
                        break;
                }
            }

            result.cold_water_type = null;
            if (engineerSystems.TypeColdWater != null)
            {
                switch (engineerSystems.TypeColdWater.ToLower())
                {
                    case "отсутствует":
                        result.cold_water_type = 1;
                        break;
                    case "центральное":
                        result.cold_water_type = 2;
                        break;
                    case "автономное":
                        result.cold_water_type = 3;
                        break;
                }
            }

            result.sewerage_type = null;
            if (engineerSystems.TypeSewage != null)
            {
                switch (engineerSystems.TypeSewage.ToLower())
                {
                    case "отсутствует":
                        result.sewerage_type = 1;
                        break;
                    case "центральное":
                        result.sewerage_type = 2;
                        break;
                    case "автономное":
                        result.sewerage_type = 3;
                        break;
                }
            }
            ...
            result.gas_type = null;
            if (engineerSystems.TypeGas != null)
            {
                switch (engineerSystems.TypeGas.ToLower())
                {
                    case "отсутствует":
                        result.gas_type = 1;
                        break;
            ...
            result.ventilation_type = null;
            if (engineerSystems.TypeVentilation != null)
            {
                switch (engineerSystems.TypeVentilation.ToLower())
                {
                    case "приточная вентиляция":
                        result.ventilation_type = 2;
                        break;
                    case "вытяжная вентиляция":
                        result.ventilation_type = 3;
                        break;
                    case "приточно-вытяжная вентиляция":
                        result.ventilation_type = 4;
                        break;
                    case "отсутствует":
                        result.ventilation_type = 1;
                        break;
                }
            }

            result.firefighting_type = null;
            if (engineerSystems.Firefighting != null)
            {
                switch (engineerSystems.Firefighting.ToLower())
                {
                    case "отсутствует":
                        result.firefighting_type = 1;
                        break;
                    case "автоматическая":
                        result.firefighting_type = 2;
                        break;
                    case "пожарные гидранты":
                        result.firefighting_type = 3;
                        break;
                }
            }

            result.drainage_type = null;
            if (engineerSystems.TypeDrainage != null)
            {
                switch (engineerSystems.TypeDrainage.ToLower())
                {
                    case "наружные водостоки":
                        result.drainage_type = 2;
                        break;
                    case "внутренние водостоки":
                        result.drainage_type = 3;
                        break;
                    case "отсутствует":
                        result.drainage_type = 1;
                        break;
                }
            }
        }
        ...
        private DisclosureInfoRealityObj GetRobjectDisclosure(RealityObject robject, PeriodDi period)
        {
            var service = this.Container.ResolveDomain<DisclosureInfoRealityObj>();
            try
            {
                return service.GetAll().FirstOrDefault(x => x.RealityObject.Id == robject.Id && x.PeriodDi.Id == period.Id);
            }
            finally
            {
                this.Container.Release(service);
