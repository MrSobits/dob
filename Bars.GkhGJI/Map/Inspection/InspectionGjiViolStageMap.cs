...
namespace Bars.GkhGji.Map
{
    ...
    public class InspectionGjiViolStageMap : BaseEntityMap<InspectionGjiViolStage>
    {
        ...
        protected override void Map()
        {
            ...
            Property(x => x.TypeViolationStage, "Тип этапа нарушения").Column("TYPE_VIOL_STAGE").NotNull();
            ...
            Property(x => x.DatePlanExtension, "продленная дата устранения").Column("DATE_PLAN_EXTENSION");
            ...
            Reference(x => x.InspectionViolation, "Нарушение проверки").Column("INSPECTION_VIOL_ID").NotNull().Fetch();
        }
    }
}
