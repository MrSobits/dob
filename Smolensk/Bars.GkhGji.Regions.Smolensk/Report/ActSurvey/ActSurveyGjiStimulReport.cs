namespace Bars.GkhGji.Regions.Smolensk.Report
{
    ...
    public class ActSurveyGjiStimulReport : GjiBaseStimulReport
    {
        ...
        public override void PrepareReport(ReportParams reportParams)
        {
            ...
            {
                Report["АдресДома1"] = realityObject.Address;

                Report["НаселенныйПункт"] = realityObject.FiasAddress.PlaceName;
            ...
            Report["ДолжностьИнспектор"] = inspectors
            ...
            Report.RegData("Инспекторы", inspectorList);
        }
