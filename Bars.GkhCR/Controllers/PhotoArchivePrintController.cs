namespace Bars.GkhCr.Controllers
{
    ...
    public class PhotoArchivePrintController : BaseController
    {
        ...
        private void PrintPage(WordDocument document, long id1, long id2, string mu, string addres, string mo, string program, string workkind, string date1, string date2)
        {
            ...
            table.Rows[2].Cells[0].CellFormat.HorizontalMerge = CellMerge.Start;
            table.Rows[2].Cells[1].CellFormat.HorizontalMerge = CellMerge.Continue;
            AddText(table.Rows[2].Cells[0], program);

            table.Rows[3].Cells[0].CellFormat.HorizontalMerge = CellMerge.Start;
            table.Rows[3].Cells[1].CellFormat.HorizontalMerge = CellMerge.Continue;
            AddText(table.Rows[3].Cells[0], mu);

            table.Rows[4].Cells[0].CellFormat.HorizontalMerge = CellMerge.Start;
            table.Rows[4].Cells[1].CellFormat.HorizontalMerge = CellMerge.Continue;
            AddText(table.Rows[4].Cells[0], addres);

            table.Rows[5].Cells[0].CellFormat.HorizontalMerge = CellMerge.Start;
            table.Rows[5].Cells[1].CellFormat.HorizontalMerge = CellMerge.Continue;
            AddText(table.Rows[5].Cells[0], workkind);

            table.Rows[6].Cells[0].CellFormat.HorizontalMerge = CellMerge.Start;
            table.Rows[6].Cells[1].CellFormat.HorizontalMerge = CellMerge.Continue;
        ...
        private void AddPhoto(WTableCell cell, long id1)
        {
            ...
            if (fileInfo != null)
            {
                try
                {
                    ...
                    {
                        withImg = (WPicture)par.AppendPicture(Image.FromStream(imageStream));
                    }
        ...
        private void AddText(WTableCell cell, string mo)
        {
            ...
            var par = cell.AddParagraph();
            par.ParagraphFormat.HorizontalAlignment = HorizontalAlignment.Center;
