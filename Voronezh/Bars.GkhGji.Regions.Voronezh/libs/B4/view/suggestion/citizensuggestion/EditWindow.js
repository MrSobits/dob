Ext.define('B4.view.suggestion.citizensuggestion.EditWindow', {
    ...
    requires: [
        ...
        'B4.store.dict.ZonalInspectionInspector',
                    ...
                    items: [
                        {
                            xtype: 'textfield',
                            name: 'Number',
                            fieldLabel: 'Номер правонарушения',
                            maxLength: 120
                        },
                        {
                            xtype: 'datefield',
                    ...
                    items: [
                        {
                            ...
                            items: [
                                {
                                    xtype: 'fieldset',
                                    title: 'Место возникновения правонарушения',
                                    items: [
                                        {
                                            xtype: 'b4selectfield',
                                            name: 'RealityObject',
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                            ...
                                            store: Ext.create('B4.base.Store', {
                                                ...
                                                proxy: {
                                                    type: 'b4proxy',
                                                    url: B4.Url.action('ListInspector', 'CitizenSuggestion')
                                                }
                                            }),
                                            columns: [
                                    ...
                                    items: [
                                        {
                                            ...
                                            fieldLabel: 'Административная комиссия',
                                            idProperty: 'Id',
                                            store: Ext.create('B4.base.Store', {
                                                autoLoad: false,
                                                fields: ['Id', 'Name'],
                                                proxy: {
                                                    type: 'b4proxy',
                                                    url: B4.Url.action('ListExecutorZonalInspection', 'CitizenSuggestion')
                                                }
                                            }),
                                            columns: [
                                                { text: 'Наименование', dataIndex: 'Name', flex: 1, filter: { xtype: 'textfield' } }
                                    ...
                                    items: [
                                        {
                                            xtype: 'b4selectfield',
                                            name: 'ProblemPlace',
                                            fieldLabel: 'Место правонарушения',
                                        ...
                                        },
                                        {
                                            xtype: 'textarea',
                                            name: 'Description',
                                            fieldLabel: 'Описание правонарушения',
                                            maxLength: 1000,
                                            allowBlank: false
                                        },
                                        //{
