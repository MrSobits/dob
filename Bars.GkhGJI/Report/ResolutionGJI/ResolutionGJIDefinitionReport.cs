    ...
    public class ResolutionGjiDefinitionReport : GjiBaseReport, IComissionMeetingCodedReport
    {
        ...
        public void GenerateMassReport()
        {
            ...
            try
            {
                ...
                this.OutputFileName =
                    $"Определение постановления {ownerInfo.Resolution.Inspection.InspectionNumber}  ({ownerInfo.DocumentNumber} - {ownerInfo.DocumentDate.Value.ToString("dd.MM.yyyy")}).docx";
