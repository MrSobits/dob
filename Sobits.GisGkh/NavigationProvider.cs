...
#pragma warning disable 618
        ...
        public void Init(MenuItem root)
        {
            ...
            root.Add("Административная комиссия").Add("Межведомственное взаимодействие").Add("Интеграция с ГИС ЖКХ", "gisgkhintegrationinsmev").AddRequiredPermission("GkhGji.GisGkh.View");
        }
    }
}