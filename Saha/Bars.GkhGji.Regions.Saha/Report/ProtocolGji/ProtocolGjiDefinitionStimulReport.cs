        ...
        public override void PrepareReport(ReportParams reportParams)
        {
            ...
            if (inspector != null)
            {
                ...
                if (!string.IsNullOrEmpty(inspector.Fio))
                {
                    ...
                    Report["ИнспекторРП"] = string.IsNullOrEmpty(inspector.FioGenitive) ? fioInspectorDp.Родительный : inspector.FioGenitive;
                    Report["ИнспекторДП"] = string.IsNullOrEmpty(inspector.FioDative) ? fioInspectorDp.Дательный : inspector.FioDative;
                }
            }
            ...
            if (roAddress.Count > 0)
            {
                ...
                Report["АдресОбъекта"] = !string.IsNullOrEmpty(str)
                                            ? str.TrimEnd(new[] { ',', ' ' })
                                            : string.Empty;
            }
        }
