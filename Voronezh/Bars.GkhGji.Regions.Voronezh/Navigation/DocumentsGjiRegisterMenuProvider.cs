namespace Bars.GkhGji.Regions.Voronezh.Navigation
{
    ...
    public class DocumentsGjiRegisterMenuProvider : INavigationProvider
    {
        ...
        public string Description => "Меню для документов комиссии";
        ...
        public void Init(MenuItem root)
        {
            ...
            root.Add("Протоколы на рассмотрение", "B4.controller.documentsgjiregister.Protocol197").AddRequiredPermission("GkhGji.DocumentsGji.Protocol197.View");
            ...
            root.Add("Протоколы 20.25", "B4.controller.documentsgjiregister.ProtocolGji").AddRequiredPermission("GkhGji.DocumentsGji.Protocol.View");
