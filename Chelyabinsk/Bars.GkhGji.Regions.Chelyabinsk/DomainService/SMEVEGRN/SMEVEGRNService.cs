...
namespace Bars.GkhGji.Regions.Chelyabinsk.DomainService
{
    public class SMEVEGRNService : ISMEVEGRNService
    {
        ...
        new XElement(tns + "header",
                    ...
                    new XElement(stCom + "requestCause", "Постановление Правительства Челябинской области от 19.09.2013 N 283-П (ред. от 20.10.2017) \"О Порядке осуществления регионального государственного жилищного надзора в Челябинской области\". Пп. 3 п. 9 Положения о Главном управлении \"Государственная Административная комиссия Челябинской области\""))),
                new XElement(tns + "declarant",
                    new XAttribute("_id", declarantId),
                    new XElement(subj + "other",
                        new XElement(subj + "name", "Главное управление \"Государственная Административная комиссия Челябинской области\""),
