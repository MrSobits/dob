namespace Bars.Gkh.Overhaul.FormatDataExport.ExportableEntities.Impl
{
    ...
    /// </summary>
    public class DogovorKprFilesExportableEntity : BaseExportableEntity
    {
        /// <inheritdoc />
        public override string Code => "DOGOVORKPRFILES";
        ...
        {
            var exportData = this.ProxySelectorFactory.GetSelector<DogovorKprProxy>()
                .ExtProxyListCache
                .Where(x => x.File != null)
