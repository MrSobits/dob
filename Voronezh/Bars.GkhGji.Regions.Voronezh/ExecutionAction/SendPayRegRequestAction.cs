...
{
    /// <summary>
    /// Периодический запрос оплат в ГИС ГМП
    /// </summary>
    public class SendPayRegRequestAction : BaseExecutionAction//, IMandatoryExecutionAction
    {
        public override string Description => "Запрашивает из ГИС ГМП все оплаты за прошедшие сутки";

        public override string Name => "Запросить оплаты в ГИС ГМП";
