namespace Bars.GkhGji.Regions.BaseChelyabinsk.Report.Protocol
{
    ...
    public class CourtPostRegistryStandaloneReport : GjiBaseStimulReport, IComissionMeetingCodedReport
    {
        public CourtPostRegistryStandaloneReport()
        ...
        public string ReportId => "CourtPostRegistryStandaloneReport";
        public string DocId { get; set; }
        protected long comissId;
        public override string Id
        {
            get { return "CourtPostRegistryStandaloneReport"; }
        }
        ...
        public string OutputFileName { get; set; } = "Почтовый реестр суд";
        ...
        public override List<TemplateInfo> GetTemplateInfo()
        {
            return new List<TemplateInfo>
            {
                new TemplateInfo
                {
                    Code = "CourtPostRegistryStandaloneReport",
                    Name = "CourtPostRegistryStandaloneReport",
        ...
        {
            this.CodeTemplate = "CourtPostRegistryStandaloneReport";
        }
