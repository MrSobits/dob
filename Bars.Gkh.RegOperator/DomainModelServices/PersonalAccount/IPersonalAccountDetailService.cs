namespace Bars.Gkh.RegOperator.DomainModelServices
{
    ...
    public interface IPersonalAccountDetailService
    {
        ...
        /// Детализация по периоду
        /// </summary>
        ListDataResult<PeriodDetail> GetPeriodDetail(BaseParams baseParams);
        ...
        /// Детализация по полям лс
        /// </summary>
        ListDataResult<FieldDetail> GetFieldDetail(BaseParams baseParams);
        ...
        /// Детализация операций по периоду
        /// </summary>
        ListDataResult<PeriodOperationDetail> GetPeriodOperationDetail(BaseParams baseParams);
    }
