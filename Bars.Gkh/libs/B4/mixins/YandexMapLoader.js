...
Ext.define('B4.mixins.YandexMapLoader', {
    ...
    // Загрузка карты в компонент. args - аргумент содержащий record. В случае модального окна лучше передовать как ссылку на аспект.
                ...
                .then(function (res) {
                    ...
                    if (firstGeoObject) {
                        ...
                        var myBalloonLayout = ymaps.templateLayoutFactory.createClass(
                            ...
                            '<p><strong>Управляющая организация:</strong> <b>$[properties.mangOrg]</b></p>'
                        );
    ...
    // Перерисовка  карты. Подразумевается что в loadMap передали ссылку на аспект у которого после этого появилась myMap. Метод используется только в модально окне
    redrawMap: function () {
    ...
    normalizeQuery: function (str) {
        ...
        // убирает буквы имени отчества в названии именной улицы
