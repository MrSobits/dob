namespace Bars.GkhGji.Regions.Chelyabinsk.Controllers
{
   ...
   // using Bars.GkhGji.Regions.Chelyabinsk.Tasks.EGRULSendInformationRequest;
    ...
    public class SMEVEGRIPExecuteController : BaseController
    {
        ...
        public SMEVEGRIPExecuteController(IFileManager fileManager, IDomainService<FileInfo> fileDomain, ITaskManager taskManager, ISmevPrintPdfHelper helper)
        {
            _fileManager = fileManager;
            _fileDomain = fileDomain;
            _taskManager = taskManager;
        ...
        public ActionResult PrintExtract(long id)
        {
            ...
            this.Response.AddHeader("Content-Disposition", $@"attachment; filename={egrip.FIO}.pdf");
