...
namespace Bars.GkhGji.Map
{
    ...
    public class PrescriptionNHibernateMapping : JoinedSubclassMapping<Prescription>
    {
        public PrescriptionNHibernateMapping()
        {
            Bag(
                x => x.CloseDocs,
                m =>
                    {
                        m.Access(typeof(CamelCaseUnderscoreFieldAccess));
                        m.Key(k => k.Column("PRESCR_ID"));
                        m.Inverse(true);
        ...
        private class CamelCaseUnderscoreFieldAccess : FieldAccessor
        {
            public CamelCaseUnderscoreFieldAccess()
                : base(new CamelCaseUnderscoreStrategy())
            {
            }
        }
    }
