namespace Bars.GkhGji.Map
{
        ...
        where T : ViewAppealCitizens
    {
        ...
        protected override void Map()
        {
            ...
            this.Property(x => x.NumberGji, "Номер комиссии").Column("GJI_NUMBER");
            this.Property(x => x.SortableNumberGji, "Номер комиссии для сортировки").Column("GJI_NUM_SORT");
            ...
            this.Reference(x => x.ZonalInspection, "Зональная Административная комиссия").Column("ZONAINSP_ID").Fetch();
