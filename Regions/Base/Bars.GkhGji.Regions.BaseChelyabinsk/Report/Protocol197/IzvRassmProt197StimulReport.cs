namespace Bars.GkhGji.Regions.BaseChelyabinsk.Report.Protocol197
{
    ...
    public class IzvRassmProt197StimulReport : GjiBaseStimulReport, IComissionMeetingCodedReport
    {
		public IzvRassmProt197StimulReport()
            : base(new ReportTemplateBinary(Resources.ChelyabinskProtocol))
        {
        }

        #region Properties
        public string ReportId => "OprRassmProtocol197";

        public override string Id
        {
            get { return "OprRassmProtocol197"; }
        }
        ...
        {
			get { return "Определение о принятии к рассмотрению"; }
        }

        public override string Description
        {
			get { return "Определение о принятии протокола к рассмотрению"; }
        }

        public string OutputFileName { get; set; } = "Определение о принятии протокола к рассмотрению";
        ...
        public override List<TemplateInfo> GetTemplateInfo()
        {
            return new List<TemplateInfo>
            {
                new TemplateInfo
                {
                    Code = "OprRassmProtocol197",
                    Name = "OprRassmProtocol197",
                    Description = "Определение о принятии протокола к рассмотрению",
                    Template = Resources.OPRED31_REP197
                }
            };
        }
        ...
        {
			this.CodeTemplate = "OprRassmProtocol197";
        }
        ...
        public void GenerateMassReport()
        {
            ...
            try
            {
                ...
                this.OutputFileName =
                    $"Определение о принятии протокола к рассмотрению {ownerInfo.Inspection.InspectionNumber}  ({ownerInfo.DocumentNumber} - {ownerInfo.DocumentDate.Value.ToString("dd.MM.yyyy")}).docx";
