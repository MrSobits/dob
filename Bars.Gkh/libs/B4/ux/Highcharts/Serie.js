 ...
 *     }
 *
 * Then use {@link B4.ux.Highcharts.Serie#cfg-dataIndex} to map the series data array
 *
 *     series: [{
 *         name: 'Series A',
 *         dataIndex: 'series1'
 ...
 */
Ext.define('B4.ux.Highcharts.Serie', {
    requires: [ 'B4.ux.Highcharts',
                'Ext.util.Observable'
              ],
    mixins: {
	...
	var sencha = B4.ux.Highcharts.sencha;
		 ...
		 * @param {B4.ux.Highcharts.Serie}  serie the serie where is fired
    ...
    buildInitData:function(items, data) {
        ...
        if (B4.ux.Highcharts.sencha.product == 't') {
