namespace Bars.Gkh.RegOperator.Migrations._2017.Version_2017062600
{
    ...
    public class UpdateSchema : Migration
    {
        ...
        public override void Up()
        {
            ...
            this.Database.AddExportId("REGOP_CALC_ACC", FormatDataExportSequences.ContragentRschetExprtId);
        }

        /// <inheritdoc/>
        public override void Down()
        {
            this.Database.AddExportId("REGOP_DEC_NOTIF", FormatDataExportSequences.ContragentRschetExprtId);
