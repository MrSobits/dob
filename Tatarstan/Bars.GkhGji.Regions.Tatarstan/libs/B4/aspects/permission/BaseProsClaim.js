Ext.define('B4.aspects.permission.BaseProsClaim', {
    ...
    permissions: [
        ...
        { name: 'GkhGji.Inspection.BaseProsClaim.Field.RegistrationNumber_View', applyTo: '[name=RegistrationNumber]', selector: '#baseProsClaimEditPanel' },
        { name: 'GkhGji.Inspection.BaseProsClaim.Field.RegistrationNumber_Edit', applyTo: '[name=RegistrationNumber]', selector: '#baseProsClaimEditPanel' },
        { name: 'GkhGji.Inspection.BaseProsClaim.Field.RegistrationNumberDate_View', applyTo: '[name=RegistrationNumberDate]', selector: '#baseProsClaimEditPanel' },
        { name: 'GkhGji.Inspection.BaseProsClaim.Field.RegistrationNumberDate_Edit', applyTo: '[name=RegistrationNumberDate]', selector: '#baseProsClaimEditPanel' },
        { name: 'GkhGji.Inspection.BaseProsClaim.Field.CheckDayCount_View', applyTo: '[name=CheckDayCount]', selector: '#baseProsClaimEditPanel' },
        { name: 'GkhGji.Inspection.BaseProsClaim.Field.CheckDayCount_Edit', applyTo: '[name=CheckDayCount]', selector: '#baseProsClaimEditPanel' },
