    ...
    aspects: [
        ...
        },
        {
        ...
        },
         {
             ...
             requirements: [
                 {
                     name: 'GkhGji.Inspection.BaseProsClaim.MainInfo.Field.RegistrationNumber',
                     applyTo: '[name=RegistrationNumber]',
                     selector: '#baseProsClaimEditPanel'
                 },
                 {
                     name: 'GkhGji.Inspection.BaseProsClaim.MainInfo.Field.RegistrationNumberDate',
                     applyTo: '[name=RegistrationNumberDate]',
                     selector: '#baseProsClaimEditPanel'
                 },
                 {
                     name: 'GkhGji.Inspection.BaseProsClaim.MainInfo.Field.CheckDayCount',
