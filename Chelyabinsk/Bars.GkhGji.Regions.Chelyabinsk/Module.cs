    ...
    public partial class Module : AssemblyDefinedModule
    {
        ...
        private void ReplaceComponents()
        {
            ...
            Container.ReplaceComponent<IResolutionService>(
                ...
                Component.For<IResolutionService>().ImplementedBy<Bars.GkhGji.Regions.Chelyabinsk.DomainService.ResolutionService>().LifeStyle.Transient);
            ...
            Container.ReplaceComponent<IGisGkhRegionalService>(
                ...
                Component.For<IGisGkhRegionalService>().ImplementedBy<Bars.GkhGji.Regions.Chelyabinsk.DomainService.GisGkhRegional.Impl.GisGkhRegionalService>().LifeStyle.Transient);

            this.Container.ReplaceTransient<IGkhBaseReport, GkhGji.Regions.BaseChelyabinsk.Report.ActCheck.ActCheckGjiStimulReport, ChelyabinskActCheckGjiStimulReport>();
            this.Container.ReplaceTransient<IGkhBaseReport, GkhGji.Regions.BaseChelyabinsk.Report.ChelyabinskDisposalStimulReport, GjiChelyabinskDisposalStimulReport>();
        }
        ...
        private void RegisterServices()
        {
            ...
            Component.For<IPredLicIP>().ImplementedBy<pmvGZHIgzhiPredLicIP>().AsWcfSecurityService().RegisterIn(this.Container);
            Component.For<IPredLicUL>().ImplementedBy<pmvGZHIgzhiPredLicUL>().AsWcfSecurityService().RegisterIn(this.Container);
            Component.For<IPereofIP>().ImplementedBy<pmvGZHIgzhiPereofIP>().AsWcfSecurityService().RegisterIn(this.Container);
            Component.For<IPereofUL>().ImplementedBy<pmvGZHIgzhiPereofUL>().AsWcfSecurityService().RegisterIn(this.Container);
            Component.For<IDublikatIP>().ImplementedBy<pmvGZHIgzhiDublikatIP>().AsWcfSecurityService().RegisterIn(this.Container);
            Component.For<IDublikatUL>().ImplementedBy<pmvGZHIgzhiDublikatUL>().AsWcfSecurityService().RegisterIn(this.Container);
        ...
        private void RegisterDomainServices()
        {
            this.Container.ReplaceTransient<ITaskCalendarService, Bars.GkhGji.Regions.BaseChelyabinsk.DomainService.TaskCalendarService,
                 Bars.GkhGji.Regions.Chelyabinsk.DomainService.TaskCalendarService>();
