namespace Bars.GkhGji.Regions.Voronezh
{
    ...
    public class Module : AssemblyDefinedModule
    {
        ...
        public override void Install()
        {
            ...
            this.Container.RegisterImport<ASFKImport>(ASFKImport.Id);
        ...
        private void RegisterControllers()
        {
            ...
            //АСФК
            Container.RegisterAltDataController<ASFK>();
            Container.RegisterController<BDOPERController>();
            Container.RegisterAltDataController<VTOPER>();
    ...
    //        Container.RegisterController<SMEVEDOExecuteController>();
        ...
        private void RegisterServices()
        {
         ...
         //   Container.RegisterTransient<IGISERPService, GISERP502Service>();
            ...
            //АСФК
            Container.RegisterTransient<IBDOPERService, BDOPERService>();
        }
        ...
        private void RegisterRules()
        {
            ...
            this.Container.RegisterTransient<IRuleChangeStatus, ComplaintsInWorkRule>();
            this.Container.RegisterTransient<IRuleChangeStatus, ComplaintsAcceptRule>();
            this.Container.RegisterTransient<IRuleChangeStatus, ComplaintsDeclineRule>();
        ...
        private void RegisterViewModels()
        {
            ...
            //АСФК
            Container.RegisterViewModel<ASFK, ASFKViewModel>();
            Container.RegisterViewModel<VTOPER, VTOPERViewModel>();
            Container.RegisterViewModel<BDOPER, BDOPERViewModel>();
        ...
        private void RegisterInterceptors()
        {
            ...
            Container.RegisterDomainInterceptor<Protocol197Violation, Protocol197ViolationInterceptor>();
            Container.RegisterDomainInterceptor<AppealCitsRequest, AppealCitsRequestInterceptor>();

            //АСФК
            Container.RegisterDomainInterceptor<ASFK, ASFKInterceptor>();
            Container.RegisterDomainInterceptor<BDOPER, BDOPERInterceptor>();
        }
