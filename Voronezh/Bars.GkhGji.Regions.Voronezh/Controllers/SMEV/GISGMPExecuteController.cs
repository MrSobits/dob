namespace Bars.GkhGji.Regions.Voronezh.Controllers
{
    ...
    public class GISGMPExecuteController : BaseController
    {
        ...
        public ActionResult CheckAnswer(BaseParams baseParams, Int64 taskId)
        {
            ...
            try
            {
                var taskInfo = _taskManager.CreateTasks(new GetRPGUAnswersTaskProvider(_container), baseParams).Data.Descriptors.FirstOrDefault();
                if (taskInfo == null)
                    return JsFailure("Сбой создания задачи");
                else
            ...
            try
            {
                if (entity != null && entity.TypeDocumentGji == TypeDocumentGji.Protocol197)
                {
                    ...
                    if (children != null)
                    {
                        ...
                        string typeInitiativeOrg = resol.TypeInitiativeOrg == TypeInitiativeOrgGji.Court ? "суда" : "комиссии";
                        ...
                        else
                        {
                            ...
                            if (entity.IndividualPerson != null)
                            {
                                ...
                                seriesfl = entity.IndividualPerson.PassportSeries;
                                numberfl = entity.IndividualPerson.PassportNumber;
                            }
                        ...
                        if (oktmo == "" && entity.ZonalInspection != null)
                        {
                            oktmo = entity.ZonalInspection.Oktmo;
                        }
                    }
                }
            }
