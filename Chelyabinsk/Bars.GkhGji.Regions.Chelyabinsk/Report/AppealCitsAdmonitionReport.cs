    ...
    public class AppealCitsAdmonitionReport : GkhBaseStimulReport
    {
        ...
        public override void PrepareReport(ReportParams reportParams)
        {
            ...
            try
            {
                ...
                Report["Подразделение"] = data.Inspector != null ? data.Inspector.Description : "";
                Report["ИсполнительФИО"] = data.Executor != null ? data.Executor.Fio : "";
                Report["ИсполнительДолжность"] = data.Executor != null ? data.Executor.PositionAblative : "";
                Report["ИсполнительФИО"] = data.Executor != null ? data.Executor.FioAblative : "";
                Report["ИсполнительПодразделение"] = data.Executor != null ? data.Executor.Description : "";
            }
            finally
            {
            ...
            Report["НарушенияСписком"] = violList;
            ...
            Report["АдресОтдела"] = zonalInsp.Address;
        }
