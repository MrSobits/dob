...
namespace Bars.GkhGji.Map
{
    ...
    public class AppealCitsMap : BaseEntityMap<AppealCits>
    {
        ...
        protected override void Map()
        {
            ...
            this.Property(x => x.NumberGji, "Номер комиссии").Column("GJI_NUMBER").Length(255);
            this.Property(x => x.SortNumberGji, "Номер комиссии для сортировок").Column("GJI_NUM_SORT");
            ...
            this.Reference(x => x.ZonalInspection, "Зональная Административная комиссия").Column("ZONAINSP_ID");
