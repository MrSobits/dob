namespace Bars.GkhGji.Regions.Voronezh.StateChanges
{
    ...
    public class ComplaintsDeclineRule : IRuleChangeStatus
    {
        /// <summary>
        ...
        public string Id
        {
            get { return "ComplaintsDeclineRule"; }
        }

        public string Name { get { return "Отклонение жалобы"; } }
        public string TypeId { get { return "gji_smev_complaints"; } }
        public string Description
        {
            get
            {
                return "При переводе статуса будет отправлен отчет об отклонении заявки на досудебное обжалование";
            }
        }
        ...
        public ValidateResult Validate(IStatefulEntity statefulEntity, State oldState, State newState)
        {
            ...
            KndRequest rejectRequest = new KndRequest
            {
            ...
            {
                var voidRequestElement = ToXElement<KndRequest>(rejectRequest);
                SMEVComplaintsRequest voidRequestRequest = new SMEVComplaintsRequest
                {
                    CalcDate = DateTime.Now,
                    TypeComplainsRequest = BaseChelyabinsk.Enums.TypeComplainsRequest.Decline,
