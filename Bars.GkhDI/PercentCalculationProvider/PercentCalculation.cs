namespace Bars.GkhDi.PercentCalculationProvider
{
    ...
    public class PercentCalculation : BasePercentCalculation
    {
        ...
        protected List<int> mandatoryServiceCodes = new List<int> { 1, 2, 6, 7, 13, 14, 27, 28, 8, 9, 10, 11, 12, 16, 18, 17, 19, 20, 22, 21 };
        ...
        protected override void CalculateRealObj()
        {
            var diRoQuery = this.DisInfoRoDomain
                         .GetAll().Where(x => this.moRoQuery.Any(y => y.RealityObject.Id == x.RealityObject.Id) && x.PeriodDi.Id == this.period.Id);
            ...
            var services = this.BaseServiceDomain.GetAll()
               ...
               .ToDictionary(
                    ...
                    y => y.Select(x => new ServiceProxy
                          ...
                          .Where(x => this.mandatoryServiceCodes.Contains(x.Code)));
            ...
            foreach (var diRealityObj in diRealObjs)
            {
                ...
                tempPositionsCount = this.mandatoryServiceCodes.Count;
                tempCompletePositionsCount = 0;
                percent = 0;
