namespace Bars.GkhDi.PercentCalculationProvider
{
    ...
    public partial class PercentCalculation988
    {
        ...
        protected virtual int[] CalculableCommunalServices { get; } = {17, 18, 19, 20, 21, 22, 33};
        protected virtual int[] RequiredCommunalServices { get; } = {17, 18, 19, 20, 21, 22};
        protected virtual int[] RequiredHousingService { get; set; } = { };
        protected virtual int[] CalculableHousingServices { get; } = { 1, 2, 6, 8, 9, 11, 12, 13, 14, 16 };
        ...
        protected virtual void PrepareRealityObjectCache(IQueryable<DisclosureInfoRealityObj> diRoQuery)
        {
            ...
            this.RequiredHousingService = this.TemplateServiceDomain.GetAll()
                ...
                // Капремонт с 2016 года необязателен
                .WhereIf(this.period.DateStart >= new DateTime(2016, 1, 1), x => x.KindServiceDi != KindServiceDi.CapitalRepair)
            ...
            this.InfoAboutUseCommonFacilitiesDict = this.InfoAboutUseCommonFacilitiesDomain.GetAll()
                ...
                .AsEnumerable()
                .GroupBy(x => x.DisclosureInfoRealityObj.RealityObject.Id)
                .ToDictionary(
                    x => x.Key,
                    y => y.Select(
            ...
            this.DocumentsRealityObjProtocolDict = this.DocumentsRealityObjProtocolDomain.GetAll()
                .Where(x => diRoQuery.Any(y => y.RealityObject.Id == x.RealityObject.Id))
        ...
        protected virtual DiRealObjPercent CalculatePlaceGeneralUsePercent(DisclosureInfoRealityObjProxy realObj)
        {
            ...
            {
                var infoAboutUseCommonFacilities = this.InfoAboutUseCommonFacilitiesDict.Get(realObj.RoId);
        ...
        protected virtual DiRealObjPercent CalculateDocumentsDiRealObjPercent(DisclosureInfoRealityObjProxy realObj)
        {
            ...
            if (docs.IsNotNull())
            {
                ...
                {
                    var docProtocols = this.DocumentsRealityObjProtocolDict.Get(realObj.RoId);
