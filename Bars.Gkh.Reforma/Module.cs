namespace Bars.Gkh.Reforma
{
    ...
    public class Module : AssemblyDefinedModule
    {
        ...
        private void RegisterTaskScheduler()
        {
            ...
            Component.For<IScheduler>()
                ...
                {
                    var scheduler = k.Resolve<ISchedulerFactory>("ReformaTaskSchedulerFactory").GetScheduler();
    ...
    internal static class WindsorExtensions
    {
            ...
            where TImpl : TService where TService : class
        {
            ...
            container.Register(config(Component.For<TService>().ImplementedBy<TImpl>()).LifeStyle.SessionScoped());
        }
    }
}