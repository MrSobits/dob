namespace Bars.Gkh.Controllers.Config
{
    ...
    public class GkhConfigController : BaseController
    {
        ...
        public GkhConfigController(IGkhConfigService configService)
        {
            this.ConfigService = configService;
        }

        private IGkhConfigService ConfigService { get; set; }
        ...
        {
            return new JsonNetResult(this.ConfigService.GetAllConfigs());
        }
    }
}