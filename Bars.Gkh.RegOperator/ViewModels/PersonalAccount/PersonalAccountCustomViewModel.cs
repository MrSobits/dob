namespace Bars.Gkh.RegOperator.ViewModels.PersonalAccount
{
    ...
    internal class PersonalAccountCustomViewModel : IPersonalAccountCustomViewModel
    {
        ...
        public ListDataResult<AccountByRealityObjectDto> ListAccountByRealityObject(BaseParams baseParams)
        {
            ...
            return new ListDataResult<AccountByRealityObjectDto>(result.Order(loadParams).ToArray(), result.Count());
        }
    }
}