namespace Bars.Gkh.RegOperator.Distribution
{
    ...
    internal static class DistributionHelper
    {
        ...
        {
            var ids = @params.Params.GetAs("distributionIds", new long[0]);
            var distributionSource = @params.Params.GetAs<DistributionSource>("distributionSource");

            return DistributionHelper.GetObjectByType(distributionSource, ids);
        }
        ...
        public static IDistributable ExtractDistributable(BaseParams baseParams)
        {
            var distributionId = baseParams.Params.GetAsId("distributionId");
