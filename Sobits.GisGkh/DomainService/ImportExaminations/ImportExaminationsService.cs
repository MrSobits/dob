                            ...
                            if (inspection != null)
                            {
                                ...
                                if (disposal.GisGkhGuid == null || disposal.GisGkhGuid == "")
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if(exportable)
                                        {
                                            ...
                                            if (disposal.TypeAgreementProsecutor == TypeAgreementProsecutor.RequiresAgreement)
                                            {
                                                   ...
                                                   (!string.IsNullOrEmpty(disposal.DocumentNumberWithResultAgreement) && disposal.DocumentDateWithResultAgreement.HasValue))
                                                {
                                                    if (disposal.TypeAgreementResult == TypeAgreementResult.Agreed)
                                                    {
                                                        ExaminationInfo.ProsecutorAgreementInformation = new ProsecutorAgreementInformationType
                                                        {
                                                            ...
                                                            {
                                                                ItemsChoiceType6.Agreed,
                                                                ItemsChoiceType6.OrderNumber,
                                                                ItemsChoiceType6.OrderDate
                                                            },
                                                            Items = new object[]
                                                            {
                                                                true,
                                                ...
                                                else
                                                {
                                                    ExaminationInfo.ProsecutorAgreementInformation = new ProsecutorAgreementInformationType
                                                    {
                                                        ItemsElementName = new ItemsChoiceType6[]
                                                        {
                                                            ItemsChoiceType6.NoAgreementInformation
                                                        },
                                                        Items = new object[]
                                                        {
                                                            true
                                            ...
                                            List<ItemsChoiceType9> ItemsElementName = new List<ItemsChoiceType9>
                                            {
                                                ItemsChoiceType9.Examination
                                            };
                                            ...
                                            if (disposal.NcDate.HasValue)
                                            {
                                                notif = new ExaminationTypeNotificationInfo
                                                {
                                                    ...
                                                    {
                                                ItemsChoiceType5.NotificationDate,
                                                ItemsChoiceType5.NotificationMethod
                                                    },
                                                    Items = new object[]
                                                    {
                                            ...
                                            var ExaminationType = new ExaminationType
                                            {
                                                ExaminationOverview = new ExaminationTypeExaminationOverview
                                                {
                                                    ...
                                                    {
                                                ItemsChoiceType4.ShouldNotBeRegistered
                                                    },
                                                    Items = new object[]
                                                    {
                                                true
                                            ...
                                            {
                                                ItemsElementName.Add(ItemsChoiceType9.ImportPrecept);
                                                Items.Add(ImportPrecept);
                                            }

                                            foreach (var ImportOffence in ImportOffenceList)
                                            {
                                                ItemsElementName.Add(ItemsChoiceType9.ImportOffence);
                                ...
                                else
                                {
                                    ...
                                    if (ResultInfo != null || ImportPreceptList.Count() > 0 || ImportOffenceList.Count() > 0)
                                    {
                                        ...
                                        if (ResultInfo != null)
                                        {
                                            ItemsElementName.Add(ItemsChoiceType9.ResultsInfo);
                                        ...
                                        ItemsElementName.Add(ItemsChoiceType9.ExaminationChangeInfo);
            ...
            foreach (var prescription in prescriptions)
            {
                ...
                if (prescriptionViols.Count() > 0)
                {
                    ...
                    if (AttachmentList.Count() > 0)
                    {
                        ...
                        ((PreceptType)precept.Item).Attachment = new AttachmentType[] { };
                        ((PreceptType)precept.Item).Attachment = AttachmentList.ToArray();
                    }
                    PrescriptionRepo.Update(prescription);
        ...
        private List<importExaminationsRequestImportExaminationImportOffence> GetOffences(List<DocumentGji> docProtocols, string OrgPPAGUID, ref string log)
        {
            ...
            foreach (var protocol in protocols)
            {
                ...
                if (protocolViols.Count() > 0)
                {
                    ...
                    if (AttachmentList.Count() > 0)
                    {
                        ((OffenceType)offence.Item).Attachment = new AttachmentType[] { };
                        ((OffenceType)offence.Item).Attachment = AttachmentList.ToArray();
                    }
                    ProtocolRepo.Update(protocol);
                        ...
                        if (actAnnexes.Count > 0)
                        {
                            ...
                            ResultsInfoType resultInfo = new ResultsInfoType
                            {
                                FinishedInfo = new ResultsInfoTypeFinishedInfo
                                {
                                    ...
                                    OtherDocument = OtherDocumentList.ToArray()
                                },
                            ...
                            if (NotFamiliarize)
                            {
                                resultInfo.FamiliarizationInfo.ItemsElementName = new ItemsChoiceType8[]
                                {
                            ItemsChoiceType8.NotFamiliarize
                                };
                            ...
                            else
                            {
                                resultInfo.FamiliarizationInfo.ItemsElementName = new ItemsChoiceType8[]
                                {
                            ItemsChoiceType8.FamiliarizationDate,
                            ItemsChoiceType8.FamiliarizedPerson,
                            ...
                            ItemsChoiceType7.IdentifiedOffencesInfo
                                };
