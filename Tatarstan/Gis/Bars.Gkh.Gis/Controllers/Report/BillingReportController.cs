namespace Bars.Gkh.Gis.Controllers.Report
{
    ...
    using B4.Modules.ReportPanel.Entities;
    using B4.Utils.Web;
    ...
    public class BillingReportController : B4.Alt.DataController<PrintForm>
    {
        ...
        public ActionResult GetReport(BaseParams baseParams)
        {
            ...
            var fileId = Path.Combine(HttpContext.Request.ApplicationPath ?? "",
        ...
        public override void ExecuteResult(ControllerContext context)
        {
            switch (ResultCode)
            {
                case ResultCode.Success:
                    ...
                    context.HttpContext.Response.AddHeader("Content-Disposition", "inline; filename=" + FileName);
