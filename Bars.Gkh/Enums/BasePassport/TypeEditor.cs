namespace Bars.Gkh.Enums.BasePassport
{
    ...
    public enum TypeEditor : int
    {
        ...
        [Display("Выбор типа проекта")]
        [XmlEnum(Name="TypeProject")]
        TypeProject = 80,
        ...
        [Display("Тип стен")]
        [XmlEnum(Name="TypeWalls")]
        TypeWalls = 220,
        
        [Display("Тип перекрытий")]
        [XmlEnum(Name="TypeFloor")]
        TypeFloor = 230,
