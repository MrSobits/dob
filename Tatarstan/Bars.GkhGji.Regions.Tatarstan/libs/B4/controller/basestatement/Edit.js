            ...
            */
            ...
            listeners: {
                getdata: function (asp, records) {
                    ...
                    var tfAppealCits = asp.getSelectField();
                    var val = tfAppealCits.getValue();
                    var rawval = tfAppealCits.getRawValue();
                    ...
                    if (recordIds[0] > 0) {
                        ...
                        B4.Ajax.request(B4.Url.action('AddAppealCitizens', 'BaseStatement', {
                            ...
                            tfAppealCits.updateDisplayedText(rawval);
                            tfAppealCits.setValue(val);
