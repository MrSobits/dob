namespace Bars.Gkh.Overhaul
{
    ...
    using Bars.Gkh.Overhaul.FormatDataExport.ExportableEntities.Impl;
    ...
    using MainProxySelectors = Gkh.FormatDataExport.ProxySelectors.Impl;
    ...
    public partial class Module : AssemblyDefinedModule
    {
        ...
        {
            ContainerHelper.RegisterExportableEntity<ActWorkDogovExportableEntity>(this.Container);
            ContainerHelper.RegisterExportableEntity<BankExportableEntity>(this.Container);
            ContainerHelper.RegisterExportableEntity<ContragentRschetExportableEntity>(this.Container);
            ContainerHelper.RegisterExportableEntity<DogovorKprExportableEntity>(this.Container);
            ContainerHelper.RegisterExportableEntity<DogovorKprFilesExportableEntity>(this.Container);
            ContainerHelper.RegisterExportableEntity<KapremProtocolossExportableEntity>(this.Container);
            ContainerHelper.RegisterExportableEntity<KapremProtocolFilesExportableEntity>(this.Container);
            ContainerHelper.RegisterExportableEntity<KprExportableEntity>(this.Container);
            ContainerHelper.RegisterExportableEntity<WorkKprExportableEntity>(this.Container);
            ContainerHelper.RegisterExportableEntity<WorkKprTypeExportableEntity>(this.Container);
            ContainerHelper.RegisterExportableEntity<WorkDogovExportableEntity>(this.Container);

            ContainerHelper.RegisterProxySelectorService<ActWorkDogovProxy, ActWorkDogovSelectorService>(this.Container);
            ContainerHelper.RegisterProxySelectorService<ContragentRschetProxy, ContragentRschetSelectorService>(this.Container);
            ContainerHelper.RegisterProxySelectorService<DogovorKprProxy, DogovorKprSelectorService>(this.Container);
            ContainerHelper.RegisterProxySelectorService<WorkDogovProxy, WorkDogovSelectorService>(this.Container);

            ContainerHelper.ReplaceProxySelectorService<ContragentProxy,
                MainProxySelectors.ContragentSelectorService,
                ContragentSelectorService>(this.Container);
        }
    }
}