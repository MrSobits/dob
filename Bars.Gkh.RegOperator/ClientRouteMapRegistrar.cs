...
namespace Bars.Gkh.RegOperator
{
    public class ClientRouteMapRegistrar: IClientRouteMapRegistrar
    {
        public void RegisterRoutes(ClientRouteMap map)
        {
            ...
            map.AddRoute(new ClientRoute("persaccdistribution/{id}&{code}&{sum}&{src}", "B4.controller.distribution.PersonalAccount"));
            map.AddRoute(new ClientRoute("work_act_distribution/{id}&{code}&{sum}&{src}", "B4.controller.distribution.PerformedWorkAct", requiredPermission: "GkhRegOp.Accounts.BankOperations.Distributions.PerformedWorkActsDistribution"));
            map.AddRoute(new ClientRoute("realtyaccdistribution/{id}&{code}&{sum}&{src}", "B4.controller.distribution.RealtyAccount"));
            map.AddRoute(new ClientRoute("transferctrdistribution/{id}&{code}&{sum}&{src}", "B4.controller.distribution.TransferContractor"));
            map.AddRoute(new ClientRoute("refundtransferctrdistribution/{id}&{code}&{sum}&{src}", "B4.controller.distribution.RefundTransferContractor"));
