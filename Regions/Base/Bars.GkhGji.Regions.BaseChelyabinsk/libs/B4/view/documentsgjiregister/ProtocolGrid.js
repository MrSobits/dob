Ext.define('B4.view.documentsgjiregister.ProtocolGrid', {
    ...
    alias: 'widget.registerprotocol2025grid',
    closable: true,
        ...
        Ext.applyIf(me, {
            ...
            columns: [
                ...
                },
                {
                    ...
                    text: 'Должности членов комиссии',
                    filter: {
                        xtype: 'b4combobox',
                ...
                {
                    xtype: 'gridcolumn',
                    dataIndex: 'JudSectorName',
                    width: 50,
                    text: 'Судебный участок',
                    filter: {
                        xtype: 'textfield'
                    }
                },
                {
                    xtype: 'datecolumn',
                    dataIndex: 'DateToCourt',
                    text: 'Дата направления в суд',
                    format: 'd.m.Y',
                    ...
                    items: [
                        {
                            ...
                            items: [
                                ...
                                },
                                {
                                    ...
                                    action: 'ProtocolPrint',
                                    name: 'ProtocolPrint',
                                    itemId: 'btnProtocolPrint'
                                }
                            ]
                        }
                    ]
