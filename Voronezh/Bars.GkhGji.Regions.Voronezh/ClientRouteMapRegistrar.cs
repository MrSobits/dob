namespace Bars.GkhGji.Regions.Voronezh
{
    ...
    public class ClientRouteMapRegistrar : IClientRouteMapRegistrar
    {
        public void RegisterRoutes(ClientRouteMap map)
        {
            ...
            //АСФК
            map.AddRoute(new ClientRoute("asfk", "B4.controller.ASFK", requiredPermission: "GkhGji.ASFK.View"));
            map.AddRoute(new ClientRoute("asfkimport", "B4.controller.Import.ASFK", requiredPermission: "Import.ASFK.View"));
            ...
            map.AddRoute(new ClientRoute("changepremisesstate", "B4.controller.SMEVChangePremisesState", requiredPermission: "GkhGji.SMEV.SMEVExploitResolution.View"));
