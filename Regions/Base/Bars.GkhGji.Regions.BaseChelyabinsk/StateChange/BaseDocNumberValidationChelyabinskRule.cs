namespace Bars.GkhGji.Regions.BaseChelyabinsk.StateChange
{
    ...
    public abstract class BaseDocNumberValidationChelyabinskRule : IRuleChangeStatus
    {
        ...
        private void SetDisposalDocNum(DocumentGji document)
        {
        ...
        private void SetDocNum(DocumentGji document)
        {
            var typeDoc = new[]
            {
                TypeDocumentGji.Disposal, TypeDocumentGji.ProtocolMhc, TypeDocumentGji.ProtocolMvd
            };
